...
(function(exports) {
  ...
  var ParentQuery = (function () {
      function ParentQuery(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ParentQuery.create = function (value0) {
          return function (value1) {
              return new ParentQuery(value0, value1);
          };
      };
      return ParentQuery;
  })();
  ...
  var SearchReceiver = (function () {
      function SearchReceiver(value0) {
          this.value0 = value0;
      };
      SearchReceiver.create = function (value0) {
          return new SearchReceiver(value0);
      };
  ...
  var ContainerReceiver = (function () {
      function ContainerReceiver(value0) {
          this.value0 = value0;
      };
      ContainerReceiver.create = function (value0) {
          return new ContainerReceiver(value0);
      };
  ...
  var updateStore = function (r) {
      return function (f) {
          return function ($13) {
              ...
              })(Control_Comonad_Store.runStore(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(f)($13)));
          };
      };
  };
  var getState = function (dictMonadState) {
      return Control_Bind.bindFlipped((dictMonadState.Monad0()).Bind1())(function ($14) {
          return Control_Applicative.pure((dictMonadState.Monad0()).Applicative0())(Control_Comonad_Store.runStore($14));
      })(Control_Monad_State_Class.get(dictMonadState));
  };
  var emit = function (dictApplicative) {
      return function (v) {
          return function (v1) {
              return function (a) {
                  if (v1 instanceof ParentQuery) {
                      return Data_Functor.voidRight((dictApplicative.Apply0()).Functor0())(a)(v(v1.value0));
                  };
  ...
  var augmentHTML = Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray));                                                                    
  var getContainerProps = augmentHTML([ Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input_(Container.create(new Mouse(Down.value)))), Halogen_HTML_Events.onMouseUp(Halogen_HTML_Events.input_(Container.create(new Mouse(Up.value)))), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Container.create(Blur.value))), Halogen_HTML_Properties.tabIndex(0) ]);
  var getInputProps = augmentHTML([ Halogen_HTML_Events.onFocus(Halogen_HTML_Events.input_(Container.create(new Visibility(Toggle.value)))), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(function (ev) {
      return Container.create(new Key(ev));
  })), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (ev) {
      return Search.create(new TextInput(ev));
  })), Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input_(Container.create(new Mouse(Down.value)))), Halogen_HTML_Events.onMouseUp(Halogen_HTML_Events.input_(Container.create(new Mouse(Up.value)))), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Container.create(Blur.value))), Halogen_HTML_Properties.tabIndex(0) ]);
  var getItemProps = function (index) {
      return augmentHTML([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Container.create(new Select(index)))), Halogen_HTML_Events.onMouseOver(Halogen_HTML_Events.input_(Container.create(new Highlight(new Index(index))))), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(function (ev) {
          return Container.create(new Key(ev));
      })), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Container.create(Blur.value))), Halogen_HTML_Properties.tabIndex(0) ]);
  };
  var getToggleProps = augmentHTML([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Container.create(new Visibility(Toggle.value)))), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(function (ev) {
      return Container.create(new Key(ev));
  })), Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input_(Container.create(new Mouse(Down.value)))), Halogen_HTML_Events.onMouseUp(Halogen_HTML_Events.input_(Container.create(new Mouse(Up.value)))), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Container.create(Blur.value))), Halogen_HTML_Properties.tabIndex(0) ]);
...
(function(exports) {
  ...
  var preventDefault = function (dictIsEvent) {
      return function ($18) {
          return DOM_Event_Event.preventDefault(toEvent(dictIsEvent)($18));
      };
  };                                                                                                                                                        
  var isEventKeyboardEvent = new IsEvent(DOM_Classy_Util.fromAny(DOM_Event_Types.readKeyboardEvent), DOM_Event_Types.keyboardEventToEvent);           
  ...
  exports["isEventKeyboardEvent"] = isEventKeyboardEvent;
...
(function(exports) {
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var Select_Dispatch = PS["Select.Dispatch"];
  var Select_Effects = PS["Select.Effects"];        
  var Emit = (function () {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof Select_Dispatch.ParentQuery) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Halogen_Query_HalogenM.raise(new Emit(new Select_Dispatch.ParentQuery(v.value0, Data_Unit.unit))));
          };
          if (v instanceof Select_Dispatch.Search) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Halogen_Query_HalogenM.raise(new Emit(new Select_Dispatch.Search(v.value0, Data_Unit.unit))));
          };
          if (v instanceof Select_Dispatch.Container) {
              if (v.value0 instanceof Select_Dispatch.Select) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Dispatch.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var $27 = !v1.value1.open;
                      if ($27) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      };
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                          var v2 = Data_Array.index(v1.value1.items)(v.value0.value0);
                          if (v2 instanceof Data_Maybe.Just) {
                              return Halogen_Query_HalogenM.raise(new ItemSelected(v2.value0));
                          };
                          return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log("Index " + (Data_Show.show(Data_Show.showInt)(v.value0.value0) + " is out of bounds.")));
                      })());
                  });
              };
              if (v.value0 instanceof Select_Dispatch.Highlight) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Dispatch.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                          if (v.value0.value0 instanceof Select_Dispatch.Index) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  ...
                                  $36.highlightedIndex = new Data_Maybe.Just(v.value0.value0.value0);
                                  return $36;
                              }));
                          };
                          if (v.value0.value0 instanceof Select_Dispatch.Next) {
                          ...
                          if (v.value0.value0 instanceof Select_Dispatch.Prev) {
                          ...
                          throw new Error("Failed pattern match at Select.Primitive.Container line 76, column 48 - line 86, column 91: " + [ v.value0.value0.constructor.name ]);
                      })());
                  });
              };
              if (v.value0 instanceof Select_Dispatch.Key) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Dispatch.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var $60 = !v1.value1.open;
                      if ($60) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      };
                      var v2 = DOM_Event_KeyboardEvent.code(v.value0.value0);
                      if (v2 === "Enter") {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_Classy_Event.preventDefault(DOM_Classy_Event.isEventKeyboardEvent)(v.value0.value0)))(function () {
                              if (v1.value1.highlightedIndex instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              };
                              if (v1.value1.highlightedIndex instanceof Data_Maybe.Just) {
                                  return $$eval(new Select_Dispatch.Container(new Select_Dispatch.Select(v1.value1.highlightedIndex.value0), v.value1));
                              };
                              throw new Error("Failed pattern match at Select.Primitive.Container line 93, column 15 - line 95, column 64: " + [ v1.value1.highlightedIndex.constructor.name ]);
                          });
                      };
                      if (v2 === "Escape") {
                      ...
                      if (v2 === "ArrowUp") {
                          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_Classy_Event.preventDefault(DOM_Classy_Event.isEventKeyboardEvent)(v.value0.value0)))(function () {
                              return $$eval(new Select_Dispatch.Container(new Select_Dispatch.Highlight(Select_Dispatch.Prev.value), v.value1));
                          }));
                      };
                      if (v2 === "ArrowDown") {
                          return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_Classy_Event.preventDefault(DOM_Classy_Event.isEventKeyboardEvent)(v.value0.value0)))(function () {
                              return $$eval(new Select_Dispatch.Container(new Select_Dispatch.Highlight(Select_Dispatch.Next.value), v.value1));
                          }));
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              if (v.value0 instanceof Select_Dispatch.Mouse) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Dispatch.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                          if (v.value0.value0 instanceof Select_Dispatch.Down) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  var $73 = {};
                                  for (var $74 in v2) {
                          ...
                          if (v.value0.value0 instanceof Select_Dispatch.Up) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  var $76 = {};
                                  for (var $77 in v2) {
                          ...
                          throw new Error("Failed pattern match at Select.Primitive.Container line 110, column 23 - line 112, column 65: " + [ v.value0.value0.constructor.name ]);
                      })());
                  });
              };
              if (v.value0 instanceof Select_Dispatch.Blur) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Dispatch.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var $83 = !v1.value1.open || v1.value1.mouseDown;
                      if ($83) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      };
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)($$eval(new Select_Dispatch.Container(new Select_Dispatch.Visibility(Select_Dispatch.Off.value), Data_Unit.unit)));
                  });
              };
              if (v.value0 instanceof Select_Dispatch.Visibility) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                      if (v.value0.value0 instanceof Select_Dispatch.On) {
                      ...
                      if (v.value0.value0 instanceof Select_Dispatch.Off) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v1) {
                              var $90 = {};
                              for (var $91 in v1) {
                              ...
                              $90.open = false;
                              $90.highlightedIndex = Data_Maybe.Nothing.value;
                              return $90;
                          }));
                      };
                      if (v.value0.value0 instanceof Select_Dispatch.Toggle) {
                      ...
                      throw new Error("Failed pattern match at Select.Primitive.Container line 121, column 35 - line 124, column 100: " + [ v.value0.value0.constructor.name ]);
                  })());
              };
              if (v.value0 instanceof Select_Dispatch.ContainerReceiver) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Select_Dispatch.updateStore(v.value0.value0.render)(function (v1) {
                      var $97 = {};
                      for (var $98 in v1) {
                      ...
                      $97.items = v.value0.value0.items;
                      $97.highlightedIndex = Data_Maybe.Nothing.value;
                      $97.lastIndex = Data_Array.length(v.value0.value0.items) - 1 | 0;
                      return $97;
                  })));
              };
              throw new Error("Failed pattern match at Select.Primitive.Container line 62, column 24 - line 129, column 97: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Select.Primitive.Container line 55, column 12 - line 129, column 97: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState,
          render: Control_Comonad.extract(Control_Comonad_Store_Trans.comonadStoreT(Data_Identity.comonadIdentity)),
          "eval": $$eval,
          receiver: Halogen_HTML_Events.input(function ($103) {
              return Select_Dispatch.Container.create(Select_Dispatch.ContainerReceiver.create($103));
          })
      });
  })();
  exports["Emit"] = Emit;
  ...
  exports["component"] = component;
})(PS["Select.Primitive.Container"] = PS["Select.Primitive.Container"] || {});
(function(exports) {
    "use strict";
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  ...
  var Select_Dispatch = PS["Select.Dispatch"];
  var Select_Effects = PS["Select.Effects"];
  var Select_Primitive_Container = PS["Select.Primitive.Container"];
  var ItemSelected = (function () {
      function ItemSelected(value0) {
          this.value0 = value0;
      };
  ...
  var renderToggle = Halogen_HTML_Elements.div(Select_Dispatch.getToggleProps([  ]))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([ Halogen_HTML_Core.text("Select") ])(itemHTML)(selection))([ Halogen_HTML_Elements.button_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("caret") ])([  ]) ]) ]));
            
              // The individual items to render
  var renderItems = function (html) {
                  return Halogen_HTML_Elements.div(Select_Dispatch.getContainerProps([  ]))([ Halogen_HTML_Elements.ul_(html) ]);
              };
            
              // One particular item to render
  var renderItem = function (index) {
                  return function (item) {
                      return Halogen_HTML_Elements.li(Select_Dispatch.getItemProps(index)([  ]))(itemHTML(item));
                  };
              };
              return Halogen_HTML_Elements.div_((function () {
                  ...
                  return [ renderToggle, renderItems(Data_Array.mapWithIndex(renderItem)(st.items)) ];
              })());
          };
      };
  };
  ...
  var component = function (dictEq) {
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot(Data_Unit.unit)(Select_Primitive_Container.component)({
              items: st.items,
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleContainer) {
              if (v.value0 instanceof Select_Primitive_Container.Emit) {
                  return Select_Dispatch.emit(Halogen_Query_HalogenM.applicativeHalogenM)($$eval)(v.value0.value0)(v.value1);
              };
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $12 = {};
                      for (var $13 in st) {
                      ...
                      $12.selection = new Data_Maybe.Just(v.value0.value0);
                      return $12;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Dispatch.Container.create(Select_Dispatch.ContainerReceiver.create({
                              render: renderContainer(v1.itemHTML)(v1.selection),
                              items: Data_Maybe.maybe(v1.items)(Data_Function.flip(Data_Array["delete"](dictEq))(v1.items))(v1.selection)
                          })))))(function (v2) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Dispatch.Container.create(new Select_Dispatch.Visibility(Select_Dispatch.Off.value)))))(function (v3) {
              ...
              throw new Error("Failed pattern match at CN.UI.Dropdown line 102, column 30 - line 120, column 38: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at CN.UI.Dropdown line 97, column 12 - line 120, column 38: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var ItemRemoved = (function () {
      function ItemRemoved(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ItemRemoved.create = function (value0) {
          return function (value1) {
              return new ItemRemoved(value0, value1);
          };
      };
      return ItemRemoved;
  })();
  ...
  var renderContainer = function (itemHTML) {
      return function (st) {
          var renderToggle = Halogen_HTML_Elements.div(Select_Dispatch.getToggleProps([  ]))([ Halogen_HTML_Core.text("Placeholder"), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("Select") ]) ]);
          var renderItems = function (html) {
              return Halogen_HTML_Elements.div(Select_Dispatch.getContainerProps([  ]))([ Halogen_HTML_Elements.ul_(html) ]);
          };
          var renderItem = function (index) {
              return function (item) {
                  return Halogen_HTML_Elements.li(Select_Dispatch.getItemProps(index)([  ]))(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(itemHTML(item)));
              };
          };
          return Halogen_HTML_Elements.div_((function () {
              var $8 = !st.open;
  ...
  var component = function (dictEq) {
      var render = function (st) {
          var renderSelectedItem = function (item) {
              return Halogen_HTML_Elements.div_(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(st.itemHTML(item)))([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ItemRemoved.create(item))) ])([ Halogen_HTML_Core.text("X") ]) ]));
          };
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderSelectedItem)(st.selection)), Halogen_HTML.slot(Data_Unit.unit)(Select_Primitive_Container.component)({
              items: Data_Array.difference(dictEq)(st.items)(st.selection),
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof ItemRemoved) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var selection = Data_Array["delete"](dictEq)(v.value0)(v1.selection);
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Dispatch.Container.create(Select_Dispatch.ContainerReceiver.create({
                          ...
                          items: Data_Array.difference(dictEq)(v1.items)(selection)
                      })))))(function (v2) {
                          return Halogen_Query_HalogenM.raise(new SelectionChanged(selection));
                      });
                  });
              }));
          };
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var selection = Data_Array.cons(v.value0.value0)(v1.selection);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $21 = {};
                          for (var $22 in v2) {
              ...
              throw new Error("Failed pattern match at CN.UI.Multiselect line 92, column 30 - line 105, column 47: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at CN.UI.Multiselect line 75, column 12 - line 105, column 47: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
          initialState: initialState,
          render: render,
  ...
  exports["component"] = component;
  exports["renderContainer"] = renderContainer;
})(PS["CN.UI.Multiselect"] = PS["CN.UI.Multiselect"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Bind = PS["Control.Bind"];
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Select_Dispatch.Container) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Halogen_Query_HalogenM.raise(new Emit(new Select_Dispatch.Container(v.value0, Data_Unit.unit))));
          };
          if (v instanceof Select_Dispatch.Search) {
              if (v.value0 instanceof Select_Dispatch.TextInput) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Dispatch.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(v1.value1.ms))(function () {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(Control_Monad_Aff_Class.monadAffAff)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_AVar.takeVar(v2)))(function (v4) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v5) {
                                              var $26 = {};
                                              for (var $27 in v5) {
                                                  if ({}.hasOwnProperty.call(v5, $27)) {
                                                      $26[$27] = v5[$27];
                                                  };
                                              };
                                              $26.debouncer = Data_Maybe.Nothing.value;
                                              return $26;
                                          })))(function () {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Dispatch.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v5) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.killFiber(Control_Monad_Eff_Exception.error("Time's up!"))(v1.value1.debouncer.value0.fiber)))(function (v2) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(v1.value1.ms))(function () {
                                      ...
                                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v4) {
                                          var $36 = {};
                                          for (var $37 in v4) {
                                              if ({}.hasOwnProperty.call(v4, $37)) {
                                                  $36[$37] = v4[$37];
                                              };
                                          };
                                          $36.debouncer = new Data_Maybe.Just({
                          ...
                          throw new Error("Failed pattern match at Select.Primitive.Search line 64, column 11 - line 90, column 69: " + [ v1.value1.debouncer.constructor.name ]);
                      });
                  }));
              };
              if (v.value0 instanceof Select_Dispatch.SearchReceiver) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Select_Dispatch.updateStore(v.value0.value0.render)(Control_Category.id(Control_Category.categoryFn))));
              };
              throw new Error("Failed pattern match at Select.Primitive.Search line 59, column 21 - line 96, column 44: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at Select.Primitive.Search line 52, column 12 - line 96, column 44: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState,
          render: Control_Comonad.extract(Control_Comonad_Store_Trans.comonadStoreT(Data_Identity.comonadIdentity)),
  ...
  exports["component"] = component;
})(PS["Select.Primitive.Search"] = PS["Select.Primitive.Search"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Select_Effects = PS["Select.Effects"];
  var Select_Primitive_Container = PS["Select.Primitive.Container"];
  var Select_Primitive_Search = PS["Select.Primitive.Search"];        
  var HandleContainer = (function () {
      function HandleContainer(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
  ...
  var renderSelections = function (st) {
      var renderSelection = function (str) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(str) ]);
      };
      return Halogen_HTML_Elements.div_((function () {
          var $23 = Data_Array.length(st.selections) <= 0;
          if ($23) {
              return [  ];
          };
          return [ Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderSelection)(st.selections)) ];
      })());
  };
  var renderContainer = function (st) {
      var renderItems = function (html) {
          return Halogen_HTML_Elements.div(Select_Dispatch.getContainerProps([  ]))([ Halogen_HTML_Elements.ul_(html) ]);
      };
      var renderItem = function (ix) {
          return function (item) {
              return Halogen_HTML_Elements.li(Select_Dispatch.getItemProps(ix)([  ]))([ Halogen_HTML_Core.text(item) ]);
          };
      };
      return Halogen_HTML_Elements.div_((function () {
          var $24 = !st.open;
  ...
  var ordPrimitiveSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at CN.UI.Typeahead line 58, column 8 - line 58, column 54: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var cssLabel = Halogen_HTML_Properties.class_("f6 b db mb2");
  var cssInput = Halogen_HTML_Properties.class_("input-reset pa2 mb2 db w-100 b--none");
  var cssHelperText = Halogen_HTML_Properties.class_("f6 black-60 db mb2");
  var textField = function (label) {
      return function (placeholder) {
          return function (helper) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("measure") ])([ Halogen_HTML_Elements.label([ cssLabel ])([ Halogen_HTML_Core.text(label) ]), Halogen_HTML_Elements.input(Select_Dispatch.getInputProps([ cssInput, Halogen_HTML_Properties.placeholder(placeholder) ])), Halogen_HTML_Elements.small([ cssHelperText ])([ Halogen_HTML_Core.text(helper) ]) ]);
          };
      };
  };
  var renderSearch = function (st) {
      return textField("Search Field")("Type to search...")("This typeahead is automatically debounced at 150ms.");
  };
  var component = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ renderSelections(st), Halogen_HTML.slot(new Slot(SearchSlot.value))(Select_Primitive_Search.component)({
              render: renderSearch,
              search: Data_Maybe.Nothing.value,
              debounceTime: 150.0
          })(Halogen_HTML_Events.input(HandleSearch.create)), Halogen_HTML.slot(new Slot(ContainerSlot.value))(Select_Primitive_Container.component)({
      ...
      var $$eval = function (v) {
          if (v instanceof HandleSearch) {
              if (v.value0 instanceof Select_Primitive_Search.Emit) {
                  if (v.value0.value0 instanceof Select_Dispatch.Container) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Dispatch.Container.create(v.value0.value0.value0))))(function (v1) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  };
                  if (v.value0.value0 instanceof Select_Dispatch.ParentQuery) {
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)($$eval(v.value0.value0.value0));
                  };
                  if (v.value0.value0 instanceof Select_Dispatch.Search) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  };
                  throw new Error("Failed pattern match at CN.UI.Typeahead line 107, column 25 - line 116, column 31: " + [ v.value0.value0.constructor.name ]);
              };
              if (v.value0 instanceof Select_Primitive_Search.NewSearch) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      var matches = function (i) {
                          return Data_Array.filter(function (i$prime) {
                              return Data_String.contains(i)(i$prime);
                          });
                      };
                      var available = Data_Array.difference(Data_Eq.eqString)(matches(v.value0.value0)(v1.items))(v1.selections);
                      var newItems = (function () {
                          if (Data_Array.length(available) < 1) {
                              return Data_Array.cons(v.value0.value0)(available);
                          };
                          if (Data_Boolean.otherwise) {
                              return available;
                          };
                          throw new Error("Failed pattern match at CN.UI.Typeahead line 124, column 15 - line 126, column 51: " + [  ]);
                      })();
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Dispatch.Container.create(new Select_Dispatch.ContainerReceiver({
                          render: renderContainer,
                          items: newItems
                      })))))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              ...
              throw new Error("Failed pattern match at CN.UI.Typeahead line 106, column 33 - line 134, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof HandleContainer) {
              if (v.value0 instanceof Select_Primitive_Container.Emit) {
                  return Select_Dispatch.emit(Halogen_Query_HalogenM.applicativeHalogenM)($$eval)(v.value0.value0)(v.value1);
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $54 = Data_Array.length(Data_Array.filter(Data_Eq.eq(Data_Eq.eqString)(v.value0.value0))(v1.items)) > 0;
                          if ($54) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $55.selections = Data_Array.cons(v.value0.value0)(v1.selections);
                                  return $55;
                              });
                          };
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $58.items = Data_Array.cons(v.value0.value0)(v1.items);
                              $58.selections = Data_Array.cons(v.value0.value0)(v1.selections);
                              return $58;
                          });
                      })())(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              var newItems = Data_Array.difference(Data_Eq.eqString)(v2.items)(v2.selections);
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Dispatch.Container.create(new Select_Dispatch.ContainerReceiver({
                                  render: renderContainer,
                                  items: newItems
                              })))))(function (v3) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqSlot)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Dispatch.Container.create(new Select_Dispatch.Visibility(Select_Dispatch.Off.value)))))(function (v4) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                          });
              ...
              throw new Error("Failed pattern match at CN.UI.Typeahead line 136, column 36 - line 159, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Receive) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $65.items = v.value0.items;
                  return $65;
              }))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          throw new Error("Failed pattern match at CN.UI.Typeahead line 105, column 12 - line 161, column 68: " + [ v.constructor.name ]);
      };
  ...
  exports["cssHelperText"] = cssHelperText;
...
(function(exports) {
  ...
  var CN_UI_Multiselect = PS["CN.UI.Multiselect"];
  ...
  var HandleMultiselect = (function () {
      function HandleMultiselect(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleMultiselect.create = function (value0) {
          return function (value1) {
              return new HandleMultiselect(value0, value1);
          };
      };
      return HandleMultiselect;
  })();
  var cssTitle = Halogen_HTML_Properties.class_("f1 lh-title");
  var title = Halogen_HTML_Elements.h1([ cssTitle ])([ Halogen_HTML_Core.text("CitizenNet Select Components") ]);
  var cssIntroText = Halogen_HTML_Properties.class_("f4 lh-copy");
  var introduction = Halogen_HTML_Elements.p([ cssIntroText ])([ Halogen_HTML_Core.text("A demonstration of various pre-built selection components ready to be dropped in to Wildcat screens. This can be used to verify that components behave and look as expected & required.") ]);
  var cssExampleTitle = Halogen_HTML_Properties.class_("f2 lh-title");
  var cssExampleDescription = Halogen_HTML_Properties.class_("f4 lh-copy black-70");
  var cssExampleBlock = Halogen_HTML_Properties.class_("pa4 bg-near-white");
  var mountWith = function (title1) {
      return function (body) {
          return function (slot) {
              return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.h2([ cssExampleTitle ])([ Halogen_HTML_Core.text(title1) ]), Halogen_HTML_Elements.p([ cssExampleDescription ])([ Halogen_HTML_Core.text(body) ]), Halogen_HTML_Elements.div([ cssExampleBlock ])([ slot ]) ]);
          };
      };
  };
  var containerData = [ "item one", "item two", "who knows" ];
  var component = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("mw6 mw7-ns center pa2 ph4-ns black-80 sans-serif") ])([ title, introduction, mountWith("Select Field")("Selects a single item from a list.")(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(CN_UI_Dropdown.component(Data_Eq.eqString))({
              items: containerData,
              itemHTML: function (i) {
                  return [ Halogen_HTML_Core.text(i) ];
              }
          })(Halogen_HTML_Events.input(HandleDropdown.create))), mountWith("Multiselect Field")("Selects multiple items from a list.")(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(CN_UI_Multiselect.component(Data_Eq.eqString))({
              items: containerData,
              itemHTML: function (i) {
                  return [ Halogen_HTML_Core.text(i) ];
              },
              selection: [ "item one" ]
          })(Halogen_HTML_Events.input(HandleMultiselect.create))), mountWith("Typeahead")("Captures string input and produces a menu.")(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(CN_UI_Typeahead.component)({
              items: containerData
          })(Data_Void.absurd)) ]);
      };
      var $$eval = function (v) {
          ...
          if (v instanceof HandleMultiselect) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
          throw new Error("Failed pattern match at Base.Component line 97, column 5 - line 97, column 58: " + [ v.constructor.name ]);
      };
  ...
  exports["HandleMultiselect"] = HandleMultiselect;
  exports["component"] = component;
  exports["containerData"] = containerData;
  exports["cssTitle"] = cssTitle;
  exports["cssExampleTitle"] = cssExampleTitle;
  exports["cssExampleDescription"] = cssExampleDescription;
  exports["cssIntroText"] = cssIntroText;
  exports["cssExampleBlock"] = cssExampleBlock;
  exports["title"] = title;
  exports["introduction"] = introduction;
  exports["mountWith"] = mountWith;
