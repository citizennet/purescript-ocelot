...
(function(exports) {
  ...
  var inactiveTabClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "text-grey", "border-b-2", "hover:border-blue", "hover:text-white" ]);
...
(function(exports) {
  ...
  var css = function ($73) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($73));
  };
  ...
  var navigationTabBlock = function (dictMonadAff) {
      return documentationBlock("Navigation Tabs")("Tabs for navigating, eg. between form pages")(componentBlock("No configuration set.")(CN_UI_Block_NavigationTab.navigationTabs(Data_Eq.eqBoolean)(tabConfig)));
  };
  ...
  var cnDocumentationBlocks = function (dictMonadAff) {
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(navigationTabBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(switchBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(radioBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(inputBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(formInputBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockStrings(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockUsers(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockTodos(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dropdownBlock(dictMonadAff))(buttonBlock(dictMonadAff))))))))));
  };
  var component = function (dictMonadAff) {
      var replaceItems = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at UIGuide.Components.TextFields line 115, column 5 - line 115, column 31: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
      var render = function (st) {
