...
(function(exports) {
  ...
  var showRemoteData = function (dictShow) {
      return function (dictShow1) {
          return new Data_Show.Show(function (v) {
              ...
              throw new Error("Failed pattern match at Network.RemoteData line 43, column 1 - line 43, column 69: " + [ v.constructor.name ]);
          });
      };
  };
  ...
  exports["showRemoteData"] = showRemoteData;
...
(function(exports) {
  ...
  var functorSyncMethod = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          if (m instanceof ContinuousAsync) {
              return new ContinuousAsync(m.value0, Data_Functor.map(Network_RemoteData.functorRemoteData)(f)(m.value1));
          };
          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 92, column 8 - line 92, column 62: " + [ m.constructor.name ]);
      };
  });
          ...
          return function (item) {
              return function (items) {
                  return function (selections) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 387, column 36 - line 389, column 70: " + [ selections.constructor.name ]);
                  };
              };
          };
      };
          ...
          return function (item) {
              return function (items) {
                  return function (selections) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 370, column 36 - line 373, column 63: " + [ selections.constructor.name ]);
                  };
              };
          };
      };
              ...
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(Data_Unit.unit)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 558, column 3 - line 561, column 45: " + [ v1.value0.constructor.name ]);
                      })())(function () {
              ...
              return function (item) {
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(Data_Unit.unit)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 508, column 3 - line 511, column 45: " + [ v2.value0.constructor.name ]);
                      })())(function () {
  ...
  var applyInsertable = function (items) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 485, column 29 - line 488, column 61: " + [ v.insertable.constructor.name ]);
                  };
  ...
  var applyFilter = function (items) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 474, column 7 - line 479, column 69: " + [ v.filterType.constructor.name ]);
                  };
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              if (v1.value1.items instanceof Async) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Async.create(v1.value1.items.value0)(Data_Functor.map(Network_RemoteData.functorRemoteData)(function ($238) {
                                      return applyInsertable(applyFilter($238));
                                  })(v1.value1.items.value1)));
                              };
                              if (v1.value1.items instanceof ContinuousAsync) {
                                  var continuous = new ContinuousAsync(new Data_Tuple.Tuple(v1.value1.items.value0.value0, text), Network_RemoteData.Loading.value);
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                      var $159 = {};
                                      for (var $160 in v2) {
                                      ...
                                      $159.items = continuous;
                                      return $159;
                                  })))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log("Requested new data in evalNewSearch.")))(function () {
                              ...
                              throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 422, column 15 - line 434, column 23: " + [ v1.value1.items.constructor.name ]);
                          })())(function (v2) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 436, column 8 - line 446, column 53: " + [ v2.constructor.name ]);
                              })())(function (v3) {
          ...
          var $$eval = function (v) {
              if (v instanceof HandleContainer) {
                  ...
                  if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 267, column 11 - line 269, column 58: " + [ v1.value1.config.constructor.name ]);
                      }));
                  };
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 259, column 36 - line 269, column 58: " + [ v.value0.constructor.name ]);
              };
              if (v instanceof HandleSearch) {
                  ...
                  if (v.value0 instanceof Select_Primitives_Search.NewSearch) {
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 285, column 11 - line 287, column 55: " + [ v1.value1.config.constructor.name ]);
                      }));
                  };
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 272, column 33 - line 287, column 55: " + [ v.value0.constructor.name ]);
              };
              if (v instanceof Remove) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 292, column 9 - line 294, column 45: " + [ v1.value1.config.constructor.name ]);
                  }));
              };
              ...
              if (v instanceof FulfillRequest) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log("Received new data in FulfillRequest.")))(function () {
                          var updateContainer = function (v1) {
                              if (v1 instanceof Network_RemoteData.Failure) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqSlot)(Data_Either.eqEither(eqSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Primitives_Container.Visibility.create(Select_Primitives_Container.Off.value))))(function (v2) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqSlot)(Data_Either.eqEither(eqSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Primitives_Container.ReplaceItems.create([  ]))))(function (v3) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log("Updated container with new data in FulfillRequest.")))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          });
                      });
              ...
              throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 257, column 12 - line 342, column 35: " + [ v.constructor.name ]);
          };
      ...
      return function (renderItem) {
          return function (v) {
              var unpack = function (v1) {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 97, column 5 - line 97, column 34: " + [ v1.constructor.name ]);
              };
              var renderSelections = (function () {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 103, column 7 - line 122, column 12: " + [ v.selections.constructor.name ]);
              })();
  ...
  var testAsyncMulti$prime = function (dictStringComparable) {
      return function (dictEq) {
          return function (source) {
              return {
                  items: new CN_UI_Core_Typeahead.ContinuousAsync(new Data_Tuple.Tuple(source, source), Network_RemoteData.NotAsked.value),
                  debounceTime: 500.0,
                  search: Data_Maybe.Nothing.value,
...
(function(exports) {
  ...
  var showTodo = new Data_Show.Show(function (v) {
      return v.title + (" " + Data_Show.show(Data_Show.showBoolean)(v.completed));
  });
  ...
  var fetchTodos = Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableJson)("https://jsonplaceholder.typicode.com/todos"))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff_Console.log("Fetching todos..."))(function () {
          ...
          throw new Error("Failed pattern match at UIGuide.Utilities.Async line 28, column 3 - line 30, column 36: " + [ v1.constructor.name ]);
      });
  });
...
(function(exports) {
  ...
  var css = function ($36) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($36));
  };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleTypeahead) {
              if (v.value0 instanceof CN_UI_Core_Typeahead.RequestData && v.value0.value0 instanceof CN_UI_Core_Typeahead.Async) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(UIGuide_Utilities_Async.fetchTodos))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Halogen_Query.action(CN_UI_Core_Typeahead.FulfillRequest.create(new CN_UI_Core_Typeahead.Async(v.value0.value0.value0, v1)))))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              };
              if (v.value0 instanceof CN_UI_Core_Typeahead.RequestData && v.value0.value0 instanceof CN_UI_Core_Typeahead.ContinuousAsync) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(UIGuide_Utilities_Async.fetchTodos))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.logShow(Network_RemoteData.showRemoteData(Data_Show.showString)(Data_Show.showArray(UIGuide_Utilities_Async.showTodo)))(v1)))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Halogen_Query.action(CN_UI_Core_Typeahead.FulfillRequest.create(new CN_UI_Core_Typeahead.ContinuousAsync(v.value0.value0.value0, v1)))))(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
                  });
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 83, column 49 - line 87, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
