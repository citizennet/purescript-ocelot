...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var radioClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "checked:sibling:after:opacity-100", "checked:sibling:after:scale-1", "checked:sibling:before:border-teal", "hidden", "not:checked:sibling:after:opacity-0", "not:checked:sibling:after:scale-0" ]);
  var labelClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "after:absolute", "after:bg-teal", "after:all-02s-ease", "after:h-3", "after:left-w-6/2--w-4/2", "after:no-content", "after:rounded-full", "after:top-w-6/2--w-4/2", "after:w-3", "before:absolute", "before:border", "before:border-color-grey", "before:border-solid", "before:h-6", "before:no-content", "before:pin-l", "before:pin-t", "before:rounded-full", "before:w-6", "cursor-pointer", "inline-block", "pl-8", "relative", "text-black" ]);
  var radio = function (props) {
      return function (iprops) {
          var iprops$prime = Data_Semigroup.append(Data_Semigroup.semigroupArray)(iprops)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRadio.value), Halogen_HTML_Properties.classes(radioClasses) ]);
          return Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("h-6") ])([ Halogen_HTML_Elements.input(iprops$prime), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(labelClasses) ])([ Halogen_HTML_Core.text(props.label) ]) ]);
      };
  };
  exports["radio"] = radio;
...
(function(exports) {
  ...
  var stringComparableString = new StringComparable(function (s) {
      return s;
  });
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                          ...
                          var newItems = (function () {
                              ...
                              if (insertable instanceof Insertable) {
                                  var $81 = Data_Array.length(matches) <= 0;
                                  if ($81) {
                                      return Data_Array.cons(insertable.value0(text))(matches);
                                  };
                                  return matches;
                              };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v1) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqSlot)(Data_Either.eqEither(eqSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Primitives_Container.ReplaceItems.create(newItems))))(function (v1) {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              });
                          });
                      });
  ...
  exports["stringComparableString"] = stringComparableString;
          ...
          return function (v) {
              ...
              var renderContainer = function (v1) {
                  return function (containerState) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("relative") ])((function () {
                          var $20 = !containerState.open;
                          if ($20) {
                              return [  ];
                          };
                          return [ Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ Halogen_HTML_Properties.class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Array.mapWithIndex(renderItem(v1.search)(containerState.highlightedIndex))(containerState.items)) ]) ];
                      })());
                  };
              };
              ...
              return function (highlightIndex) {
                  return function (itemIndex) {
                      return function (item) {
                          if (v === "") {
                              var hover = (function () {
                                  var $27 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                                  if ($27) {
                                      return " bg-grey-lighter";
                                  };
                                  return "";
                          ...
                          var hover = (function () {
                              var $28 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                              if ($28) {
                                  return " bg-grey-lighter";
                              };
                              return "";
...
(function(exports) {
  ...
  var formInputBlock = documentationBlock("Input Form Block")("Some form input shit")(Halogen_HTML_Elements.div_([ CN_UI_Block_FormControl.formControl({
      label: "Email",
  ...
  var inputBlock = documentationBlock("Input")("Some input shit")(Halogen_HTML_Elements.div_([ CN_UI_Block_Input.input([ Halogen_HTML_Properties.placeholder("address@gmail.com") ]) ]));
  var radioBlock = documentationBlock("Radio")("A radio button")(Halogen_HTML_Elements.div_([ CN_UI_Block_Radio.radio({
      label: "Apples"
  ...
  var typeaheadBlock = (function () {
      var slot = Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(CN_UI_Core_Typeahead.component(Data_Eq.eqString)(CN_UI_Core_Typeahead.stringComparableString))(CN_UI_Components_Typeahead["defaultMulti'"](CN_UI_Core_Typeahead.stringComparableString)(Data_Eq.eqString)(containerData))(Halogen_HTML_Events.input(HandleTypeahead.create));
  ...
  var cnDocumentationBlocks = Data_Semigroup.append(Data_Semigroup.semigroupArray)(radioBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(inputBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(formInputBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dropdownBlock)(buttonBlock)))));
  var component = (function () {
      var render = function (st) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 71, column 49 - line 73, column 102: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 68, column 5 - line 68, column 82: " + [ v.constructor.name ]);
      };
