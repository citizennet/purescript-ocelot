  ...
  var component = function (dictMonadAff) {
      var replaceItems = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at UIGuide.Components.TextFields line 102, column 5 - line 102, column 31: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
      var render = function (st) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 95, column 49 - line 99, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 83, column 5 - line 83, column 91: " + [ v.constructor.name ]);
      };
