  ...
  var component = function (dictEq) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Removed) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Dropdown line 225, column 41 - line 229, column 78: " + [ v1.selection.constructor.name ]);
                  })()))(function (v2) {
          ...
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Dropdown line 244, column 43 - line 248, column 80: " + [ v1.selection.constructor.name ]);
                      })()))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $45 = {};
                              for (var $46 in v3) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitive_Container.ContainerReceiver.create({
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at CN.UI.Dropdown line 256, column 16 - line 260, column 44: " + [ v1.selection.constructor.name ]);
                                  })())(function (v4) {
              ...
              throw new Error("Failed pattern match at CN.UI.Dropdown line 239, column 30 - line 261, column 38: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at CN.UI.Dropdown line 216, column 12 - line 261, column 38: " + [ v.constructor.name ]);
      };
