...
(function(exports) {
  ...
  var ordTypeaheadSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 67, column 8 - line 67, column 54: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var css = function ($75) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($75));
  };
  ...
  var cnDocumentationBlocks = function (dictMonadAff) {
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(switchBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(radioBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(inputBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(formInputBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(formHeaderBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockStrings(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockUsers(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockTodos(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dropdownBlock(dictMonadAff))(buttonBlock(dictMonadAff))))))))));
  };
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 109, column 49 - line 113, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
          ...
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 91, column 5 - line 91, column 91: " + [ v.constructor.name ]);
      };
