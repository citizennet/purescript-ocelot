...
(function(exports) {
  ...
  var loadFromSource = function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableJson)(v.root + v.path))(function ($55) {
  ...
  var load = function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 46, column 1 - line 46, column 130: " + [ v.constructor.name ]);
  }; 
...
(function(exports) {
  ...
  var typeaheadBlock = (function () {
      var slot = Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(CN_UI_Core_Typeahead.component(Data_Show.showString)(UIGuide_Utilities_Async.eqTodo)(UIGuide_Utilities_Async.stringComparableTodo))(CN_UI_Components_Typeahead["testAsyncMulti'"](UIGuide_Utilities_Async.stringComparableTodo)(UIGuide_Utilities_Async.eqTodo)(Data_Show.showString)(UIGuide_Utilities_Async.todos))(Halogen_HTML_Events.input(HandleTypeahead.create));
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleTypeahead) {
              if (v.value0 instanceof CN_UI_Core_Typeahead.RequestData) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(UIGuide_Utilities_Async.load(v.value0.value0)))(function (v1) {
                      var replaceItems = function (v2) {
                          return function (v3) {
                              ...
                              throw new Error("Failed pattern match at UIGuide.Components.TextFields line 73, column 13 - line 73, column 39: " + [ v2.constructor.name, v3.constructor.name ]);
                          };
                      };
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Halogen_Query.action(CN_UI_Core_Typeahead.FulfillRequest.create(replaceItems(v1)(v.value0.value0)))))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              };
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 84, column 49 - line 88, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
