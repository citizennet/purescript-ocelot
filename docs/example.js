              ...
              return function (highlightIndex) {
                  return function (itemIndex) {
                      return function (item) {
                          if (v === "") {
                              var hover = (function () {
                                  var $29 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                                  if ($29) {
                                      return " bg-grey-lighter";
                                  };
                                  return "";
                          ...
                          var hover = (function () {
                              var $30 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                              if ($30) {
                                  return " bg-grey-lighter";
                              };
                              return "";
...
(function(exports) {
  ...
  var fetchTodos = Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableJson)("https://jsonplaceholder.typicode.com/todos"))(function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 24, column 3 - line 26, column 26: " + [ v1.constructor.name ]);
  });
