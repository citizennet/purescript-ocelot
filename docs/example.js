      ...
      var render = function (st) {
          ...
          var renderSingleToggle = function (selected) {
              var toggleProps = (function () {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Components.Dropdown line 171, column 27 - line 175, column 13: " + [ selected.constructor.name ]);
              })();
              var toggleHTML = (function () {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Components.Dropdown line 176, column 26 - line 178, column 93: " + [ selected.constructor.name ]);
              })();
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("w-full px-3") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2") ])([ Halogen_HTML_Core.text(st.title) ]), (function () {
              ...
              throw new Error("Failed pattern match at CN.UI.Components.Dropdown line 108, column 9 - line 130, column 16: " + [ st.selection.constructor.name ]);
...
(function(exports) {
  ...
  var renderSelections = function (st) {
      ...
      return Halogen_HTML_Elements.div_((function () {
          ...
          return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("bg-white rounded-sm w-full text-grey-darkest border-b border-grey-lighter") ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Functor.map(Data_Functor.functorArray)(renderSelection)(st.selections)) ]) ];
      })());
  };
  ...
  var renderContainer = function (parentSt) {
      return function (st) {
          var renderItem = function (v) {
              return function (ix) {
                  return function (item) {
                      if (v instanceof Data_Maybe.Nothing) {
                          var hover = (function () {
                              var $47 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(ix));
                              if ($47) {
                                  return " bg-grey-lighter";
                              };
                              return "";
                      ...
                      if (v instanceof Data_Maybe.Just) {
                          var hover = (function () {
                              var $48 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(ix));
                              if ($48) {
                                  return " bg-grey-lighter";
                              };
                              return "";
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("relative") ])((function () {
              ...
              return [ Halogen_HTML_Elements.div(Select_Primitive_Container.getContainerProps([ Halogen_HTML_Properties.class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Array.mapWithIndex(renderItem(parentSt.search))(st.items)) ]) ];
          })());
      };
  };
  var component = (function () {
          ...
          if (v instanceof Remove) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      $53.selections = Data_Array.filter(function (str) {
                          return v.value0 !== str;
                      })(v1.selections);
                      return $53;
                  }))(function () {
                      return $$eval(new HandleSearch(new Select_Primitive_Search.NewSearch(Data_Maybe.fromMaybe("")(v1.search)), v.value1));
                  });
              });
          };
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $72 = Data_Array.length(Data_Array.filter(Data_Eq.eq(Data_Eq.eqString)(v.value0.value0))(v1.items)) > 0;
                          if ($72) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $73.selections = Data_Array.cons(v.value0.value0)(v1.selections);
                                  return $73;
                              });
                          };
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $76.items = Data_Array.cons(v.value0.value0)(v1.items);
                              $76.selections = Data_Array.cons(v.value0.value0)(v1.selections);
                              return $76;
                          });
                      })())(function () {
