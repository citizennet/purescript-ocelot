...
(function(exports) {
      ...
      return function (item) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              var v1 = (function () {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 351, column 40 - line 353, column 74: " + [ v.value1.selections.constructor.name ]);
              })();
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
      ...
      return function (item) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              var v1 = (function () {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 322, column 40 - line 325, column 79: " + [ v.value1.selections.constructor.name ]);
              })();
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                  return State((function () {
                      var $66 = {};
  ...
  var ordPrimitiveSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 193, column 8 - line 193, column 54: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
          ...
          var $$eval = function (v) {
              if (v instanceof HandleContainer) {
                  ...
                  if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 235, column 11 - line 237, column 44: " + [ v1.value1.config.constructor.name ]);
                      }));
                  };
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 226, column 36 - line 237, column 44: " + [ v.value0.constructor.name ]);
              };
              if (v instanceof HandleSearch) {
                  ...
                  if (v.value0 instanceof Select_Primitives_Search.NewSearch) {
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 254, column 11 - line 256, column 41: " + [ v1.value1.config.constructor.name ]);
                      }));
                  };
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 240, column 33 - line 256, column 41: " + [ v.value0.constructor.name ]);
              };
              if (v instanceof Remove) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 261, column 9 - line 263, column 43: " + [ v1.value1.config.constructor.name ]);
                  }));
              };
              ...
              throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 224, column 12 - line 272, column 35: " + [ v.constructor.name ]);
          };
      ...
      return function (v) {
          ...
          var renderContainer = function (v1) {
              return function (containerState) {
                  var renderItem = function (v2) {
                      return function (ix) {
                          return function (item) {
                              if (v2 === "") {
                                  var hover = (function () {
                                      var $19 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(containerState.highlightedIndex)(new Data_Maybe.Just(ix));
                                      if ($19) {
                                          return " bg-grey-lighter";
                                      };
                                      return "";
                              ...
                              var hover = (function () {
                                  var $20 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(containerState.highlightedIndex)(new Data_Maybe.Just(ix));
                                  if ($20) {
                                      return " bg-grey-lighter";
                                  };
                                  return "";
                  ...
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("relative") ])((function () {
                      var $21 = !containerState.open;
                      if ($21) {
                          return [  ];
                      };
                      return [ Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ Halogen_HTML_Properties.class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Array.mapWithIndex(renderItem(v1.search))(containerState.items)) ]) ];
                  })());
              };
          };
