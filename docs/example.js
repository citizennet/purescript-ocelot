...
(function(exports) {
  ...
  var buttonTypeClasses = function (v) {
      if (v instanceof Default) {
          return [ "bg-grey-light hover:bg-grey" ];
      };
      if (v instanceof Primary) {
          return [ "bg-teal hover:bg-teal-dark text-white" ];
      };
      throw new Error("Failed pattern match at CN.UI.Block.Button line 25, column 1 - line 25, column 54: " + [ v.constructor.name ]);
  };
  var buttonClasses = [ "px-3 py-2 rounded shadow text-sm" ];
...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var labelClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "leading-loose", "text-black", "text-sm" ]);
  ...
  var formControl = function (props) {
      return function (html) {
          ...
          var helpText = function (v) {
              ...
              throw new Error("Failed pattern match at CN.UI.Block.FormControl line 43, column 5 - line 44, column 5: " + [ v.constructor.name ]);
          };
          return Halogen_HTML_Elements.fieldset_([ Halogen_HTML_Elements.label([  ])([ label(props.label), html, helpText(props.helpText) ]) ]);
      };
  };
...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var inputClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "bg-white", "cc-teal", "disabled:bg-grey-light", "focus:no-outline", "font-light", "px-4", "py-2", "rounded-sm", "text-sm", "w-full" ]);
...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var spanClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "after:absolute", "after:bg-grey-darkest", "after:block", "after:h-4", "after:no-content", "after:pin-l", "after:rounded-lg", "after:w-4", "before:absolute", "before:no-content", "before:", "bg-grey-light", "items-center", "flex", "h-3", "relative", "rounded-lg", "shadow-inner", "w-8" ]);
...
(function(exports) {
  ...
  var CompareToString = function (compareToString) {
      this.compareToString = compareToString;
  };
  var selectItem = function (dictCompareToString) {
      return function (dictEq) {
          return function (item) {
              return function (items) {
                  return function (selections) {
                      ...
                      if (selections instanceof Limit) {
                          var $62 = Data_Array.length(selections.value1) >= selections.value0;
                          if ($62) {
                              return selections;
                          };
                          return Limit.create(selections.value0)(Data_Array.cons(item)(selections.value1));
                      };
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 418, column 36 - line 421, column 75: " + [ selections.constructor.name ]);
                  };
              };
          };
      };
  };
  var removeItem = function (dictCompareToString) {
      return function (dictEq) {
          return function (item) {
              return function (items) {
                  return function (selections) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 405, column 36 - line 408, column 42: " + [ selections.constructor.name ]);
                  };
              };
          };
      };
  ...
  var functorSyncMethod = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 144, column 8 - line 144, column 69: " + [ m.constructor.name ]);
      };
  });
  ...
  var ordPrimitiveSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 103, column 8 - line 103, column 45: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var diffItemsSelections = function (dictCompareToString) {
      return function (dictEq) {
          return function (items) {
              return function (selections) {
                  var unpackSelections = function (v) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 431, column 5 - line 431, column 40: " + [ v.constructor.name ]);
                  };
                  var unpackItems = function (v) {
                      ...
                      if (v instanceof ContinuousAsync && v.value3 instanceof Network_RemoteData.Success) {
                          return v.value3.value0;
                      };
                      return [  ];
                  };
                  return Data_Array.difference(dictEq)(unpackItems(items))(unpackSelections(selections));
              };
          };
      };
  };
  var compareToStringString = new CompareToString(Control_Category.id(Control_Category.categoryFn));
  var compareToString = function (dict) {
      return dict.compareToString;
  };
  var applyInsertable = function (dictCompareToString) {
          ...
          return function (text) {
              return function (items) {
                  ...
                  if (insertable instanceof Insertable) {
                      ...
                      if (Data_Boolean.otherwise) {
                          return Data_Array.cons(insertable.value0(text))(items);
                      };
                  };
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 392, column 41 - line 395, column 57: " + [ insertable.constructor.name ]);
              };
          };
      };
  };
  var applyFilter = function (dictCompareToString) {
      return function (filterType) {
          return function (text) {
              return function (items) {
                  ...
                  if (filterType instanceof Exact) {
                      return Data_Array.filter(function (item) {
                          return Data_String.contains(text)(compareToString(dictCompareToString)(item));
                      })(items);
                  };
                  if (filterType instanceof CaseInsensitive) {
                      return Data_Array.filter(function (item) {
                          return Data_String.contains(Data_String.Pattern(Data_String.toLower(text)))(Data_String.toLower(compareToString(dictCompareToString)(item)));
                      })(items);
                  };
                  if (filterType instanceof CustomMatch) {
                      return Data_Array.filter(function (item) {
                          return filterType.value0(text)(item);
                      })(items);
                  };
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 383, column 37 - line 388, column 63: " + [ filterType.constructor.name ]);
              };
          };
      };
  };
  var component = function (dictMonadAff) {
      return function (dictCompareToString) {
          return function (dictEq) {
              return function (dictShow) {
                  var updateContainerWith = function (v) {
                      return function (v1) {
                          if (v instanceof Network_RemoteData.Failure) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(ContainerSlot.value)(Halogen_Query.action(Select_Primitives_Container.Visibility.create(Select_Primitives_Container.Off.value))))(function (v2) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(ContainerSlot.value)(Halogen_Query.action(Select_Primitives_Container.ReplaceItems.create([  ]))))(function (v3) {
                                      return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_Console.logShow(dictShow)(v.value0));
                                  });
                              });
                          };
                          if (v instanceof Network_RemoteData.Success) {
                              var mock = new Async("", v);
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(ContainerSlot.value)(Halogen_Query.action(Select_Primitives_Container.ReplaceItems.create(diffItemsSelections(dictCompareToString)(dictEq)(mock)(v1)))))(function (v2) {
                  ...
                  var updateContainer = function (v) {
                      if (v instanceof Sync) {
                          return updateContainerWith(new Network_RemoteData.Success(v.value0));
                      };
                      if (v instanceof Async) {
                          return updateContainerWith(v.value1);
                      };
                      if (v instanceof ContinuousAsync) {
                          return updateContainerWith(v.value3);
                      };
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 352, column 5 - line 352, column 63: " + [ v.constructor.name ]);
                  };
                  var initialState = function (i) {
                      return Control_Comonad_Store.store(i.render)({
                          items: i.items,
                  ...
                  var $$eval = function (v) {
                      if (v instanceof HandleContainer) {
                          ...
                          if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                  var selections = selectItem(dictCompareToString)(dictEq)(v.value0.value0)(v1.value1.items)(v1.value1.selections);
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                      var $124 = {};
                                      for (var $125 in v2) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(ContainerSlot.value)(Halogen_Query.action(Select_Primitives_Container.ReplaceItems.create(diffItemsSelections(dictCompareToString)(dictEq)(v1.value1.items)(selections)))))(function (v2) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 249, column 36 - line 267, column 17: " + [ v.value0.constructor.name ]);
                      };
                      if (v instanceof HandleSearch) {
                          ...
                          if (v.value0 instanceof Select_Primitives_Search.NewSearch) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v1) {
                                  ...
                                  $136.search = v.value0.value0;
                                  return $136;
                              })))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                      var applyI = applyInsertable(dictCompareToString)(v1.value1.config.insertable)(v.value0.value0);
                                      var applyF = applyFilter(dictCompareToString)(v1.value1.config.filterType)(v.value0.value0);
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          if (v1.value1.items instanceof Sync) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Sync.create(applyI(applyF(v1.value1.items.value0))));
                                          };
                                          if (v1.value1.items instanceof Async) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Async.create(v1.value1.items.value0)(Data_Functor.map(Network_RemoteData.functorRemoteData)(function ($197) {
                                                  return applyI(applyF($197));
                                          ...
                                          if (v1.value1.items instanceof ContinuousAsync) {
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                                  ...
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new RequestData(cont)))(function () {
                                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(cont);
                                                  });
                                              });
                                          };
                                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 281, column 23 - line 291, column 24: " + [ v1.value1.items.constructor.name ]);
                                      })())(function (v2) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(updateContainer(v2)(v1.value1.selections))(function (v3) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 269, column 33 - line 296, column 17: " + [ v.value0.constructor.name ]);
                      };
                      if (v instanceof Remove) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              var selections = removeItem(dictCompareToString)(dictEq)(v.value0)(v1.value1.items)(v1.value1.selections);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  var $158 = {};
                                  for (var $159 in v2) {
                      ...
                      if (v instanceof FulfillRequest) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  ...
                                  var applyI = applyInsertable(dictCompareToString)(v1.value1.config.insertable)(v1.value1.search);
                                  var applyF = applyFilter(dictCompareToString)(v1.value1.config.filterType)(v1.value1.search);
                                  var newItems = Data_Functor.map(functorSyncMethod)(function ($198) {
                                      return applyI(applyF($198));
                                  })(v.value0);
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(updateContainer(newItems)(v1.value1.selections))(function (v2) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                          });
                      ...
                      if (v instanceof Initialize) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              ...
                              throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 332, column 9 - line 343, column 19: " + [ v1.value1.items.constructor.name ]);
                          });
                      };
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 248, column 12 - line 347, column 15: " + [ v.constructor.name ]);
                  };
  ...
  exports["compareToString"] = compareToString;
  exports["HandleContainer"] = HandleContainer;
  ...
  exports["diffItemsSelections"] = diffItemsSelections;
  ...
  exports["compareToStringString"] = compareToStringString;
...
(function(exports) {
                  ...
                  return function (st) {
                      var unpack = function (v) {
                          ...
                          if (v instanceof CN_UI_Core_Typeahead.Async) {
                              return Network_RemoteData.withDefault([  ])(v.value1);
                          };
                          if (v instanceof CN_UI_Core_Typeahead.ContinuousAsync) {
                              return Network_RemoteData.withDefault([  ])(v.value3);
                          };
                          throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 193, column 5 - line 193, column 27: " + [ v.constructor.name ]);
                      };
                      var renderSelections = (function () {
                          var renderSelection = function (item) {
                              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("px-4 py-1 hover:bg-grey-lighter relative") ])([ Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text(CN_UI_Core_Typeahead.compareToString(dictCompareToString)(item)) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("absolute pin-t pin-b pin-r p-1 mx-3 cursor-pointer"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(CN_UI_Core_Typeahead.Remove.create(item))) ])([ Halogen_HTML_Core.text("\xd7") ]) ]);
                          };
                          ...
                          if (st.selections instanceof CN_UI_Core_Typeahead.Limit) {
                              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("bg-white rounded-sm w-full text-grey-darkest border-b border-grey-lighter") ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Functor.map(Data_Functor.functorArray)(renderSelection)(st.selections.value1)) ]) ]);
                          };
                          throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 198, column 7 - line 223, column 12: " + [ st.selections.constructor.name ]);
                      })();
                      ...
                      var renderContainer = function (parentState) {
                          return function (containerState) {
                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("relative") ])((function () {
                                  var $50 = !containerState.open;
                                  if ($50) {
                                      return [  ];
                                  };
                                  return [ Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ Halogen_HTML_Properties.class_("absolute bg-white shadow max-h-80 overflow-y-scroll rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Array.mapWithIndex(renderItem(parentState.search)(containerState.highlightedIndex))(containerState.items)) ]) ];
                              })());
                          };
                      };
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("w-full px-3") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2") ])([ Halogen_HTML_Core.text("Typeahead") ]), renderSelections, Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(CN_UI_Core_Typeahead.SearchSlot.value)(Select_Primitives_Search.component(dictMonadAff))({
                          render: renderSearch,
                          ...
                          items: unpack(st.items)
                      })(Halogen_HTML_Events.input(CN_UI_Core_Typeahead.HandleContainer.create)), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("mt-1 text-grey-dark text-xs") ])([ Halogen_HTML_Core.text("Some helper text that might be useful.") ]) ]);
                  };
              };
          };
      };
  };
  var defaultConfig = function (dictCompareToString) {
      return function (dictEq) {
          return {
              insertable: CN_UI_Core_Typeahead.NotInsertable.value,
              filterType: CN_UI_Core_Typeahead.CaseInsensitive.value,
              keepOpen: true
          };
      };
  };
  var contAsyncConfig = function (dictCompareToString) {
      return function (dictEq) {
          return {
              insertable: CN_UI_Core_Typeahead.NotInsertable.value,
              filterType: CN_UI_Core_Typeahead.CaseInsensitive.value,
  ...
  var defaultRenderItem = function (dictCompareToString) {
      return function (v) {
          return function (highlightIndex) {
              return function (itemIndex) {
                  return function (item) {
                      if (v === "") {
                          var hover = (function () {
                              var $62 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                              if ($62) {
                                  return " bg-grey-lighter";
                              };
                              return "";
                          })();
                          return Halogen_HTML_Elements.li(Select_Primitives_Container.getItemProps(itemIndex)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("px-4 py-1 text-grey-darkest" + hover)) ]))([ Halogen_HTML_Core.text(CN_UI_Core_Typeahead.compareToString(dictCompareToString)(item)) ]);
                      };
                      var hover = (function () {
                          var $63 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                          if ($63) {
                              return " bg-grey-lighter";
                          };
                          return "";
                      })();
                      return Halogen_HTML_Elements.li(Select_Primitives_Container.getItemProps(itemIndex)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("px-4 py-1 text-grey-darkest" + hover)) ]))(boldMatches(v)(CN_UI_Core_Typeahead.compareToString(dictCompareToString)(item)));
                  };
              };
          };
      };
  };
  var defaultAsyncMulti$prime = function (dictMonadAff) {
      return function (dictCompareToString) {
          return function (dictEq) {
              return function (dictShow) {
                  return function (source) {
                      return {
                          ...
                          render: renderTA(dictMonadAff)(dictCompareToString)(dictEq)(defaultRenderItem(dictCompareToString)),
                          config: defaultConfig(dictCompareToString)(dictEq)
                      };
                  };
              };
          };
  ...
  var defaultContAsyncMulti$prime = function (dictMonadAff) {
      return function (dictCompareToString) {
          return function (dictEq) {
              return function (dictShow) {
                  return function (source) {
                      return {
                          ...
                          initialSelection: new CN_UI_Core_Typeahead.Many([  ]),
                          render: renderTA(dictMonadAff)(dictCompareToString)(dictEq)(defaultRenderItem(dictCompareToString)),
                          config: contAsyncConfig(dictCompareToString)(dictEq)
                      };
                  };
              };
          };
  ...
  var defaultMulti$prime = function (dictMonadAff) {
      return function (dictCompareToString) {
          return function (dictEq) {
              return function (dictShow) {
                  return function (xs) {
  ...
  exports["defaultMulti'"] = defaultMulti$prime;
  exports["defaultAsyncMulti'"] = defaultAsyncMulti$prime;
  exports["defaultContAsyncMulti'"] = defaultContAsyncMulti$prime;
...
(function(exports) {
  ...
  var Todos = (function () {
      function Todos(value0) {
          this.value0 = value0;
      };
      Todos.create = function (value0) {
          return new Todos(value0);
      };
      return Todos;
  })();
  var stringComparableUser = new CN_UI_Core_Typeahead.CompareToString(function (v) {
      return v.name;
  });
  var stringComparableTodo = new CN_UI_Core_Typeahead.CompareToString(function (v) {
      return v.title;
  });
  var loadFromSource = function (v) {
      if (v.speed instanceof Fast) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableJson)(v.root + v.path))(function ($89) {
      ...
      if (v.speed instanceof Fail) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableJson)(v.path))(function ($90) {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v.decoder((function (v1) {
                  return v1.response;
              })($90)));
          });
      ...
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 92, column 49 - line 98, column 32: " + [ v.speed.constructor.name ]);
  };
  var load = function (v) {
      if (v instanceof CN_UI_Core_Typeahead.Sync) {
      ...
      if (v instanceof CN_UI_Core_Typeahead.Async) {
          return Data_Functor.map(Control_Monad_Aff.functorAff)(Data_Maybe.Just.create)(loadFromSource(v.value0));
      };
      if (v instanceof CN_UI_Core_Typeahead.ContinuousAsync) {
          return Data_Functor.map(Control_Monad_Aff.functorAff)(Data_Maybe.Just.create)(loadFromSource(v.value2));
      };
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 81, column 1 - line 83, column 83: " + [ v.constructor.name ]);
  };
  ...
  var eqItem = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Users && y instanceof Users) {
              return Data_Eq.eq(eqUser)(x.value0)(y.value0);
          };
          if (x instanceof Todos && y instanceof Todos) {
              return Data_Eq.eq(eqTodo)(x.value0)(y.value0);
          };
          return false;
      };
  });
  ...
  var users = {
      ...
      speed: Fast.value,
      decoder: Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Network_RemoteData.functorRemoteData)(Data_Functor.map(Data_Functor.functorArray)(function (x) {
          return new Users(x);
      })))(decodeWith(decodeUser))
  };   
  ...
  var todos = {
      ...
      decoder: Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Network_RemoteData.functorRemoteData)(Data_Functor.map(Data_Functor.functorArray)(function (x) {
          return new Todos(x);
      })))(decodeWith(decodeTodo))
  };
  var compareToStringItem = new CN_UI_Core_Typeahead.CompareToString(function (v) {
      if (v instanceof Users) {
          return CN_UI_Core_Typeahead.compareToString(stringComparableUser)(v.value0);
      };
      if (v instanceof Todos) {
          return CN_UI_Core_Typeahead.compareToString(stringComparableTodo)(v.value0);
      };
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 34, column 1 - line 34, column 53: " + [ v.constructor.name ]);
  });
  exports["Users"] = Users;
  exports["Todos"] = Todos;
  exports["Fast"] = Fast;
  ...
  exports["compareToStringItem"] = compareToStringItem;
  exports["eqTodo"] = eqTodo;
  exports["stringComparableTodo"] = stringComparableTodo;
  exports["eqUser"] = eqUser;
  exports["stringComparableUser"] = stringComparableUser;
...
(function(exports) {
  ...
  var TypeaheadTodos = (function () {
      ...
      TypeaheadTodos.value = new TypeaheadTodos();
      return TypeaheadTodos;
  })();
  var TypeaheadUsers = (function () {
      function TypeaheadUsers() {

      };
      TypeaheadUsers.value = new TypeaheadUsers();
      return TypeaheadUsers;
  })();
  var TestRecord = function (x) {
      return x;
  };
  var SyncTypeaheadStrings = (function () {
      function SyncTypeaheadStrings() {

      };
      SyncTypeaheadStrings.value = new SyncTypeaheadStrings();
      return SyncTypeaheadStrings;
  })();
  var NoOp = (function () {
  ...
  var eqTypeaheadSlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof TypeaheadTodos && y instanceof TypeaheadTodos) {
              return true;
          };
  ...
  var ordTypeaheadSlot = new Data_Ord.Ord(function () {
      return eqTypeaheadSlot;
  }, function (x) {
      return function (y) {
          if (x instanceof TypeaheadTodos && y instanceof TypeaheadTodos) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof TypeaheadTodos) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof TypeaheadTodos) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof TypeaheadUsers && y instanceof TypeaheadUsers) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 65, column 8 - line 65, column 54: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var eqSyncTypeaheadSlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          return true;
      };
  });
  var ordSyncTypeaheadSlot = new Data_Ord.Ord(function () {
      return eqSyncTypeaheadSlot;
  }, function (x) {
      return function (y) {
          return Data_Ordering.EQ.value;
      };
  ...
  var css = function ($72) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($72));
  };
  ...
  var innerContainer = function (title) {
      return function (blocks) {
          return Halogen_HTML_Elements.div([ css("md:ml-80") ])([ Halogen_HTML_Elements.div([ css("fixed w-full z-20") ])([ Halogen_HTML_Elements.div([ css("pin-t bg-white md:hidden relative border-b border-grey-light h-12 py-8 flex items-center") ])([ Halogen_HTML_Elements.a([ css("mx-auto inline-flex items-center"), Halogen_HTML_Properties.href("#") ])([ Halogen_HTML_Core.text(title) ]) ]) ]), Halogen_HTML_Elements.div([ css("px-6 pb-8 pt-20 md:pt-16 w-full max-w-lg mx-auto") ])(blocks) ]);
      };
  };
  var containerData = [ "Instagram", "Facebook", "Twitter" ];
  var container = function (navs) {
      return function (blocks) {
          return Halogen_HTML_Elements.body([ css("font-sans font-normal text-black leading-normal"), Halogen_HTML_Properties.class_("bg-grey-lightest") ])([ Halogen_HTML_Elements.div([ css("min-h-screen") ])([ UIGuide_Blocks_Sidebar.sidebar(navs), innerContainer("CitizenNet UI Guide")(blocks) ]) ]);
      };
  };
  ...
  var typeaheadBlockTodos = function (dictMonadAff) {
      var slot = Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(TypeaheadTodos.value)(CN_UI_Core_Typeahead.component(dictMonadAff)(UIGuide_Utilities_Async.compareToStringItem)(UIGuide_Utilities_Async.eqItem)(Data_Show.showString))(CN_UI_Components_Typeahead["defaultContAsyncMulti'"](dictMonadAff)(UIGuide_Utilities_Async.compareToStringItem)(UIGuide_Utilities_Async.eqItem)(Data_Show.showString)(UIGuide_Utilities_Async.todos))(Halogen_HTML_Events.input(HandleTypeahead.create(TypeaheadTodos.value)));
  ...
  var typeaheadBlockUsers = function (dictMonadAff) {
  ...
  var buttonBlock = function (dictMonadAff) {
      return documentationBlock("Button")("Some button shit")(Halogen_HTML_Elements.div_([ CN_UI_Block_Button.button_({
          type_: CN_UI_Block_Button.Primary.value
      })([ Halogen_HTML_Core.text("Submit") ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("ml-4") ])([ CN_UI_Block_Button.button({
          type_: CN_UI_Block_Button.Default.value
      })([  ])([ Halogen_HTML_Core.text("Cancel") ]) ]) ]));
  };
  var cnDocumentationBlocks = function (dictMonadAff) {
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(switchBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(radioBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(inputBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(formInputBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockStrings(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockUsers(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockTodos(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dropdownBlock(dictMonadAff))(buttonBlock(dictMonadAff)))))))));
  };
  var component = function (dictMonadAff) {
      var replaceItems = function (v) {
          return function (v1) {
              ...
              if (v instanceof Data_Maybe.Just && v1 instanceof CN_UI_Core_Typeahead.Sync) {
                  return v1;
              };
              if (v instanceof Data_Maybe.Just && v1 instanceof CN_UI_Core_Typeahead.Async) {
                  return new CN_UI_Core_Typeahead.Async(v1.value0, v.value0);
              };
              ...
              throw new Error("Failed pattern match at UIGuide.Components.TextFields line 114, column 5 - line 114, column 31: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
      var render = function (st) {
          return container(UIGuide_Blocks_Sidebar.cnNavSections)(cnDocumentationBlocks(dictMonadAff));
      };
      var $$eval = function (v) {
          ...
          if (v instanceof HandleTypeahead) {
              if (v.value1 instanceof CN_UI_Core_Typeahead.RequestData) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(dictMonadAff)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(UIGuide_Utilities_Async.load(v.value1.value0)))(function (v1) {
                      return Halogen_Query["query'"](Data_Either.eqEither(eqTypeaheadSlot)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(eqSyncTypeaheadSlot)(Data_Eq.eqVoid))))(Halogen_Component_ChildPath.cp1)(v.value0)(Halogen_Query.action(CN_UI_Core_Typeahead.FulfillRequest.create(replaceItems(v1)(v.value1.value0))));
                  })))(function (v1) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 107, column 49 - line 111, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 89, column 5 - line 89, column 91: " + [ v.constructor.name ]);
      };
  ...
  exports["eqSyncTypeaheadSlot"] = eqSyncTypeaheadSlot;
  exports["ordSyncTypeaheadSlot"] = ordSyncTypeaheadSlot;
  exports["eqTypeaheadSlot"] = eqTypeaheadSlot;
  exports["ordTypeaheadSlot"] = ordTypeaheadSlot;
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(UIGuide_Components_TextFields.component(Control_Monad_Aff_Class.monadAffAff))(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
