...
(function(exports) {
  ...
  var ordTypeaheadSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 51, column 8 - line 51, column 54: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var cnDocumentationBlocks = Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockTodos)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockUsers)(dropdownBlock));
      ...
      var $$eval = function (v) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(UIGuide_Utilities_Async.load(v.value1.value0)))(function (v1) {
                      var replaceItems = function (v2) {
                          return function (v3) {
                              ...
                              throw new Error("Failed pattern match at UIGuide.Components.TextFields line 82, column 13 - line 82, column 39: " + [ v2.constructor.name, v3.constructor.name ]);
                          };
                      };
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 93, column 49 - line 97, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 75, column 5 - line 75, column 82: " + [ v.constructor.name ]);
      };
