  ...
  var renderContainer = function (itemHTML) {
      return function (st) {
          var renderItems = function (html) {
              return Halogen_HTML_Elements.div(Select_Primitive_Container.getContainerProps([  ]))([ Halogen_HTML_Elements.ul_(html) ]);
          };
          var renderItem = function (index) {
              return function (item) {
                  return Halogen_HTML_Elements.li(Select_Primitive_Container.getItemProps(index)([  ]))(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(itemHTML(item)));
              };
          };
  ...
  var component = function (dictEq) {
      var render = function (st) {
          var renderSingleToggle = function (selected) {
              return Halogen_HTML_Elements.div(Select_Primitive_Container.getToggleProps(ToContainer.create)([  ]))(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([ Halogen_HTML_Core.text("Select") ])(st.itemHTML)(selected))([ Halogen_HTML_Elements.button_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("caret") ])([  ]) ]) ])));
          };
          var renderSelectedItem = function (item) {
              return Halogen_HTML_Elements.li_(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(st.itemHTML(item)))([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Removed.create(item))) ])([ Halogen_HTML_Core.text("X") ]) ]));
          };
          var renderMultiToggle = Halogen_HTML_Elements.div(Select_Primitive_Container.getToggleProps(ToContainer.create)([  ]))([ Halogen_HTML_Core.text("Select") ]);
          ...
          if (st.selection instanceof Multi) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderSelectedItem)(st.selection.value0)), renderMultiToggle, Halogen_HTML.slot(Data_Unit.unit)(Select_Primitive_Container.component)({
                  items: Data_Array.difference(dictEq)(st.items)(st.selection.value0),
                  render: renderContainer(st.itemHTML)
              })(Halogen_HTML_Events.input(HandleContainer.create)) ]);
          };
          throw new Error("Failed pattern match at CN.UI.Dropdown line 92, column 17 - line 114, column 12: " + [ st.selection.constructor.name ]);
      };
      var initialState = function (i) {
          return {
              items: i.items,
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Removed) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Dropdown line 152, column 41 - line 156, column 78: " + [ v1.selection.constructor.name ]);
                  })()))(function (v2) {
          ...
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Dropdown line 171, column 43 - line 175, column 80: " + [ v1.selection.constructor.name ]);
                      })()))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $39 = {};
                              for (var $40 in v3) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitive_Container.ContainerReceiver.create({
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at CN.UI.Dropdown line 183, column 16 - line 187, column 44: " + [ v1.selection.constructor.name ]);
                                  })())(function (v4) {
              ...
              throw new Error("Failed pattern match at CN.UI.Dropdown line 166, column 30 - line 188, column 38: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at CN.UI.Dropdown line 143, column 12 - line 188, column 38: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var renderSelections = function (st) {
      var renderSelection = function (str) {
          return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("px-4 py-1 text-grey-darkest") ])([ Halogen_HTML_Core.text(str) ]);
      };
      return Halogen_HTML_Elements.div_((function () {
          var $24 = Data_Array.length(st.selections) <= 0;
          if ($24) {
              return [  ];
          };
          return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("bg-white rounded-sm w-full border-b border-grey-lighter") ])([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Functor.map(Data_Functor.functorArray)(renderSelection)(st.selections)) ]) ];
      })());
  };
  var renderSearch = function (v) {
  ...
  var renderContainer = function (st) {
      var renderItem = function (ix) {
          return function (item) {
              var hover = (function () {
                  var $25 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(st.highlightedIndex)(new Data_Maybe.Just(ix));
                  if ($25) {
                      return " bg-grey-lighter";
                  };
                  return "";
              })();
              return Halogen_HTML_Elements.li(Select_Primitive_Container.getItemProps(ix)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("px-4 py-1 text-grey-darkest" + hover)) ]))([ Halogen_HTML_Core.text(item) ]);
          };
      };
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("relative") ])((function () {
          ...
          return [ Halogen_HTML_Elements.div(Select_Primitive_Container.getContainerProps([ Halogen_HTML_Properties.class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Array.mapWithIndex(renderItem)(st.items)) ]) ];
      })());
  };
  ...
  var ordPrimitiveSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at CN.UI.Typeahead line 63, column 8 - line 63, column 54: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var component = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("w-full px-3") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2") ])([ Halogen_HTML_Core.text("Typeahead") ]), renderSelections(st), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(new Slot(SearchSlot.value))(Select_Primitive_Search.component)({
              render: renderSearch,
              search: Data_Maybe.Nothing.value,
              debounceTime: 150.0
          })(Halogen_HTML_Events.input(HandleSearch.create)), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(new Slot(ContainerSlot.value))(Select_Primitive_Container.component)({
              render: renderContainer,
              items: st.items
          })(Halogen_HTML_Events.input(HandleContainer.create)), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("mt-1 text-grey-dark text-xs") ])([ Halogen_HTML_Core.text("This typeahead automatically debounces at 150ms.") ]) ]);
      };
      var $$eval = function (v) {
          if (v instanceof HandleSearch) {
              ...
              if (v.value0 instanceof Select_Primitive_Search.NewSearch) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      ...
                      var newItems = (function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Typeahead line 130, column 15 - line 132, column 51: " + [  ]);
                      })();
              ...
              throw new Error("Failed pattern match at CN.UI.Typeahead line 119, column 33 - line 141, column 45: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof HandleContainer) {
              if (v.value0 instanceof Select_Primitive_Container.Emit) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)($$eval(v.value0.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $50 = Data_Array.length(Data_Array.filter(Data_Eq.eq(Data_Eq.eqString)(v.value0.value0))(v1.items)) > 0;
                          if ($50) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $51.selections = Data_Array.cons(v.value0.value0)(v1.selections);
                                  return $51;
                              });
                          };
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $54.items = Data_Array.cons(v.value0.value0)(v1.items);
                              $54.selections = Data_Array.cons(v.value0.value0)(v1.selections);
                              return $54;
                          });
                      })())(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqSlot)(Data_Either.eqEither(eqSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Primitive_Container.ContainerReceiver.create({
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqSlot)(Data_Either.eqEither(eqSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(new Slot(ContainerSlot.value))(Halogen_Query.action(Select_Primitive_Container.Visibility.create(Select_Primitive_Container.Off.value))))(function (v4) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                          });
              ...
              throw new Error("Failed pattern match at CN.UI.Typeahead line 143, column 36 - line 164, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Receive) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $61.items = v.value0.items;
                  return $61;
              }))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          throw new Error("Failed pattern match at CN.UI.Typeahead line 118, column 12 - line 166, column 68: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var css = function ($28) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($28));
  };
  ...
  var dropdownBlock = (function () {
      var slot = Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(CN_UI_Dropdown.component(eqTestRecord))({
          items: dropdownData,
          itemHTML: function (i) {
      ...
      return documentationBlock("Dropdown")("Select from a list.")(componentBlock("Single select configuration.")(slot));
  })();
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at Base.Component line 67, column 49 - line 69, column 101: " + [ v.value0.constructor.name ]);
              })());
          };
