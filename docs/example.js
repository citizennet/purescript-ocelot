...
})(PS["Select.Primitive.State"] = PS["Select.Primitive.State"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Select_Primitive_State = PS["Select.Primitive.State"];        
  var On = (function () {
      function On() {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Select) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitive_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var $24 = !v1.value1.open;
                  if ($24) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  };
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                      if (v.value0 instanceof Index) {
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              ...
                              $34.highlightedIndex = new Data_Maybe.Just(v.value0.value0);
                              return $34;
                          }));
                      };
                      if (v.value0 instanceof Next) {
                          if (v1.value1.highlightedIndex instanceof Data_Maybe.Just && v1.value1.highlightedIndex.value0 !== v1.value1.lastIndex) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  ...
                                  $39.highlightedIndex = new Data_Maybe.Just(v1.value1.highlightedIndex.value0 + 1 | 0);
                                  return $39;
                              }));
                          };
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              ...
                              $43.highlightedIndex = new Data_Maybe.Just(0);
                              return $43;
                          }));
                      };
                      if (v.value0 instanceof Prev) {
                          if (v1.value1.highlightedIndex instanceof Data_Maybe.Just && v1.value1.highlightedIndex.value0 !== 0) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  ...
                                  $47.highlightedIndex = new Data_Maybe.Just(v1.value1.highlightedIndex.value0 - 1 | 0);
                                  return $47;
                              }));
                          };
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              ...
                              $51.highlightedIndex = new Data_Maybe.Just(v1.value1.lastIndex);
                              return $51;
                          }));
                      };
                      throw new Error("Failed pattern match at Select.Primitive.Container line 136, column 46 - line 150, column 67: " + [ v.value0.constructor.name ]);
                  })());
              });
          };
          if (v instanceof Key) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitive_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var $59 = !v1.value1.open;
                  if ($59) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  };
                  ...
                  if (v2 === "Enter") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(DOM_Event_Event.preventDefault(DOM_Event_Types.keyboardEventToEvent(v.value0))))(function () {
                          ...
                          throw new Error("Failed pattern match at Select.Primitive.Container line 157, column 13 - line 159, column 50: " + [ v1.value1.highlightedIndex.constructor.name ]);
                      });
                  };
                  if (v2 === "Escape") {
          ...
          if (v instanceof Mouse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitive_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                      ...
                      throw new Error("Failed pattern match at Select.Primitive.Container line 177, column 21 - line 179, column 63: " + [ v.value0.constructor.name ]);
                  })());
              });
          };
              ...
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                  ...
                  if (v.value0 instanceof Toggle) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (st) {
                          ...
                          $95.open = !st.open;
                          $95.highlightedIndex = Data_Maybe.Nothing.value;
                          return $95;
                      }));
                  };
                  throw new Error("Failed pattern match at Select.Primitive.Container line 188, column 35 - line 192, column 78: " + [ v.value0.constructor.name ]);
              })());
          };
          if (v instanceof ContainerReceiver) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Select_Primitive_State.updateStore(v.value0.render)(function (v1) {
                  var $100 = {};
                  for (var $101 in v1) {
                  ...
                  $100.highlightedIndex = Data_Maybe.Nothing.value;
                  $100.lastIndex = Data_Array.length(v.value0.items) - 1 | 0;
                  return $100;
              })));
          };
          throw new Error("Failed pattern match at Select.Primitive.Container line 117, column 12 - line 199, column 49: " + [ v.constructor.name ]);
      };
  ...
  var renderContainer = function (itemHTML) {
      return function (st) {
          var renderItems = function (html) {
              return Halogen_HTML_Elements.div(Select_Primitive_Container.getContainerProps([ Halogen_HTML_Properties.class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(html) ]);
          };
          var renderItem = function (index) {
              return function (item) {
                  ...
                  return Halogen_HTML_Elements.li(Select_Primitive_Container.getItemProps(index)(props))(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(itemHTML(item)));
              };
          };
      ...
      var render = function (st) {
          ...
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("w-full px-3") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2") ])([ Halogen_HTML_Core.text(st.title) ]), (function () {
              ...
              if (st.selection instanceof Multi) {
                  return Halogen_HTML_Elements.div_([ renderSelection(st.selection.value0), renderMultiToggle, Halogen_HTML.slot(Data_Unit.unit)(Select_Primitive_Container.component)({
              ...
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitive_Container.ContainerReceiver.create({
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitive_Container.ContainerReceiver.create({
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      if (v1.selection instanceof Single) {
                                          return Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitive_Container.Visibility.create(Select_Primitive_Container.Off.value)));
                                      };
                                      if (v1.selection instanceof Multi) {
...
(function(exports) {
  ...
  var getInputProps = Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray))([ Halogen_HTML_Events.onFocus(Halogen_HTML_Events.input_(FromContainer.create(Halogen_Query.action(Select_Primitive_Container.Visibility.create(Select_Primitive_Container.Toggle.value))))), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(function (ev) {
      return FromContainer.create(Halogen_Query.action(Select_Primitive_Container.Key.create(ev)));
  })), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(TextInput.create)), Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input_(FromContainer.create(Halogen_Query.action(Select_Primitive_Container.Mouse.create(Select_Primitive_Container.Down.value))))), Halogen_HTML_Events.onMouseUp(Halogen_HTML_Events.input_(FromContainer.create(Halogen_Query.action(Select_Primitive_Container.Mouse.create(Select_Primitive_Container.Up.value))))), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(FromContainer.create(Halogen_Query.action(Select_Primitive_Container.Blur.create)))), Halogen_HTML_Properties.tabIndex(0) ]);
  var component = (function () {
      var initialState = function (i) {
          return Control_Comonad_Store.store(i.render)({
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof TextInput) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitive_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(v1.value1.ms))(function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(Control_Monad_Aff_Class.monadAffAff)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_AVar.takeVar(v2)))(function (v4) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v5) {
                                          var $23 = {};
                                          for (var $24 in v5) {
                                              if ({}.hasOwnProperty.call(v5, $24)) {
                                                  $23[$24] = v5[$24];
                                              };
                                          };
                                          $23.debouncer = Data_Maybe.Nothing.value;
                                          return $23;
                                      })))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitive_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v5) {
                                      ...
                                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v5) {
                                          ...
                                          $29.debouncer = new Data_Maybe.Just({
                                              "var": v2,
                                              fiber: v3
                                          });
                                          return $29;
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.killFiber(Control_Monad_Eff_Exception.error("Time's up!"))(v1.value1.debouncer.value0.fiber)))(function (v2) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(v1.value1.ms))(function () {
                                  ...
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v4) {
                                      var $33 = {};
                                      for (var $34 in v4) {
                                          if ({}.hasOwnProperty.call(v4, $34)) {
                                              $33[$34] = v4[$34];
                                          };
                                      };
                                      $33.debouncer = new Data_Maybe.Just({
                      ...
                      throw new Error("Failed pattern match at Select.Primitive.Search line 106, column 9 - line 132, column 67: " + [ v1.value1.debouncer.constructor.name ]);
                  });
              }));
          };
          if (v instanceof Raise) {
          ...
          if (v instanceof SearchReceiver) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Select_Primitive_State.updateStore(v.value0.render)(Control_Category.id(Control_Category.categoryFn))))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          throw new Error("Failed pattern match at Select.Primitive.Search line 97, column 12 - line 139, column 73: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState,
          render: Control_Comonad.extract(Control_Comonad_Store_Trans.comonadStoreT(Data_Identity.comonadIdentity)),
...
(function(exports) {
  ...
  var searchSlot = function (i) {
      return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(new Slot(SearchSlot.value))(Select_Primitive_Search.component)(i)(Halogen_HTML_Events.input(HandleSearch.create));
  };
  ...
  var newSearchFn = function (dictEq) {
      return function (dictStringComparable) {
          return function (text) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitive_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
  ...
  var containerSlot = function (i) {
      return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(new Slot(ContainerSlot.value))(Select_Primitive_Container.component)(i)(Halogen_HTML_Events.input(HandleContainer.create));
  };
      ...
      return function (dictStringComparable) {
          ...
          var $$eval = function (v) {
              ...
              if (v instanceof HandleSearch) {
                  ...
                  if (v.value0 instanceof Select_Primitive_Search.ContainerQuery) {
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitive_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                          return State((function () {
                              ...
                              $94.items = Data_Array.cons(v.value0)(v1.value1.items);
                              $94.selections = v1.value1.selections;
                              return $94;
                          })());
                      })))(function () {
                          return Halogen_Query_HalogenM.raise(new ItemRemoved(v.value0));
  ...
  var renderTypeahead = function (dictStringComparable) {
      return function (v) {
          ...
          var renderSearch = function (v1) {
              return Halogen_HTML_Elements.input(Select_Primitive_Search.getInputProps([ Halogen_HTML_Properties.class_("placeholder-grey-dark text-grey-darkest rounded-sm bg-white py-2 px-4 block w-full appearance-none ds-input"), Halogen_HTML_Properties.placeholder("Type to search...") ]));
          };
                      ...
                      return function (ix) {
                          return function (item) {
                              if (v2 === "") {
                                  ...
                                  return Halogen_HTML_Elements.li(Select_Primitive_Container.getItemProps(ix)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("px-4 py-1 text-grey-darkest" + hover)) ]))([ Halogen_HTML_Core.text(CN_UI_Core_Typeahead.toString(dictStringComparable)(item)) ]);
                              };
                              var hover = (function () {
                              ...
                              return Halogen_HTML_Elements.li(Select_Primitive_Container.getItemProps(ix)([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("px-4 py-1 text-grey-darkest" + hover)) ]))(boldMatches(v2)(CN_UI_Core_Typeahead.toString(dictStringComparable)(item)));
                          };
                      };
                  };
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("relative") ])((function () {
                      ...
                      return [ Halogen_HTML_Elements.div(Select_Primitive_Container.getContainerProps([ Halogen_HTML_Properties.class_("absolute bg-white shadow rounded-sm pin-t pin-l w-full") ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Array.mapWithIndex(renderItem(v1.search))(st1.items)) ]) ];
                  })());
              };
          };
