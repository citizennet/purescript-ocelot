...
(function(exports) {
  ...
  var typeaheadBlock = (function () {
      var slot = Halogen_HTML.slot(Data_Unit.unit)(CN_UI_Typeahead.component)({
          items: containerData
      })(Data_Void.absurd);
  ...
  var cnDocumentationBlocks = Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlock)([  ]);
  var component = (function () {
      var render = function (st) {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Base.Component line 59, column 5 - line 59, column 78: " + [ v.constructor.name ]);
      };
