  ...
  var component = function (dictEq) {
      var render = function (st) {
          ...
          var renderSelectedItem = function (item) {
              return Halogen_HTML_Elements.li_(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(st.itemHTML(item)))([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ItemRemoved.create(item))) ])([ Halogen_HTML_Core.text("X") ]) ]));
          };
          ...
          throw new Error("Failed pattern match at CN.UI.Dropdown line 91, column 17 - line 113, column 12: " + [ st.selection.constructor.name ]);
      };
      var initialState = function (i) {
          return {
              items: i.items,
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof ItemRemoved) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Dropdown line 151, column 41 - line 155, column 78: " + [ v1.selection.constructor.name ]);
                  })()))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitive_Container.ContainerReceiver.create({
                              ...
                              return Halogen_Query_HalogenM.raise(new SelectionChanged(v2.value0));
                          });
                      });
                  });
              }));
          ...
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Dropdown line 170, column 43 - line 174, column 80: " + [ v1.selection.constructor.name ]);
                      })()))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $39 = {};
                              for (var $40 in v3) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitive_Container.ContainerReceiver.create({
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at CN.UI.Dropdown line 182, column 16 - line 186, column 44: " + [ v1.selection.constructor.name ]);
                                  })())(function (v4) {
                                      return Halogen_Query_HalogenM.raise(new SelectionChanged(v2.value0));
                                  });
                              });
              ...
              throw new Error("Failed pattern match at CN.UI.Dropdown line 165, column 30 - line 187, column 47: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at CN.UI.Dropdown line 142, column 12 - line 187, column 47: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var renderContainer = function (st) {
      ...
      var renderItem = function (ix) {
          return function (item) {
              return Halogen_HTML_Elements.li(Select_Primitive_Container.getItemProps(ix)([  ]))([ Halogen_HTML_Core.text(item) ]);
          };
      };
      return Halogen_HTML_Elements.div_((function () {
          var $24 = !st.open;
  ...
  var textField = function (label) {
      return function (placeholder) {
          return function (helper) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("measure") ])([ Halogen_HTML_Elements.label([ cssLabel ])([ Halogen_HTML_Core.text(label) ]), Halogen_HTML_Elements.input(Select_Primitive_Search.getInputProps([ cssInput, Halogen_HTML_Properties.placeholder(placeholder) ])), Halogen_HTML_Elements.small([ cssHelperText ])([ Halogen_HTML_Core.text(helper) ]) ]);
          };
      };
  };
  ...
  var component = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ renderSelections(st), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(new Slot(SearchSlot.value))(Select_Primitive_Search.component)({
              render: renderSearch,
      ...
      var $$eval = function (v) {
          if (v instanceof HandleSearch) {
              ...
              throw new Error("Failed pattern match at CN.UI.Typeahead line 113, column 33 - line 134, column 45: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof HandleContainer) {
              if (v.value0 instanceof Select_Primitive_Container.Emit) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)($$eval(v.value0.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $48 = Data_Array.length(Data_Array.filter(Data_Eq.eq(Data_Eq.eqString)(v.value0.value0))(v1.items)) > 0;
                          if ($48) {
                              return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  $49.selections = Data_Array.cons(v.value0.value0)(v1.selections);
                                  return $49;
                              });
                          };
                          return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              $52.items = Data_Array.cons(v.value0.value0)(v1.items);
                              $52.selections = Data_Array.cons(v.value0.value0)(v1.selections);
                              return $52;
                          });
                      })())(function () {
              ...
              throw new Error("Failed pattern match at CN.UI.Typeahead line 136, column 36 - line 157, column 17: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof Receive) {
              return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $59.items = v.value0.items;
                  return $59;
              }))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
          };
          throw new Error("Failed pattern match at CN.UI.Typeahead line 112, column 12 - line 159, column 68: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  // HTML
  var css = function ($27) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($27));
  };
  ...
  var componentBlock = function (config) {
      return function (slot) {
          ...
          return Halogen_HTML_Elements.div([ css("rounded overflow-hidden border-2 border-grey-light mb-8 bg-white") ])([ Halogen_HTML_Elements.div([ css("border-b-2 border-grey-light p-4") ])([ mkConfig(config) ]), Halogen_HTML_Elements.div([ css("p-4 bg-grey-lightest") ])([ slot ]) ]);
      };
  };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  if (v.value0.value0 instanceof CN_UI_Dropdown.Single) {
                      return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.logShow(Data_Show.showString)(Data_Maybe.maybe("Empty!")(function ($28) {
                          return (function (v1) {
                              return v1.name;
                          })(Data_Newtype.unwrap(newtypeTestRecord)($28));
                      })(v.value0.value0.value0)));
                  };
