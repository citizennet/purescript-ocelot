...
(function(exports) {
  ...
  var functorSyncMethod = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 114, column 8 - line 114, column 69: " + [ m.constructor.name ]);
      };
  });
          ...
          return function (item) {
              return function (items) {
                  return function (selections) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 296, column 36 - line 298, column 70: " + [ selections.constructor.name ]);
                  };
              };
          };
      };
          ...
          return function (item) {
              return function (items) {
                  return function (selections) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 309, column 36 - line 312, column 63: " + [ selections.constructor.name ]);
                  };
              };
          };
      };
  ...
  var ordPrimitiveSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 88, column 8 - line 88, column 45: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
      ...
      return function (insertable) {
          return function (text) {
              return function (items) {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 284, column 41 - line 287, column 57: " + [ insertable.constructor.name ]);
              };
          };
      };
  };
      ...
      return function (filterType) {
          return function (text) {
              return function (items) {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 276, column 37 - line 281, column 63: " + [ filterType.constructor.name ]);
              };
          };
      };
  };
          ...
          return function (dictEq) {
              return function (dictShow) {
                  ...
                  var updateContainer = function (v) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 251, column 5 - line 251, column 63: " + [ v.constructor.name ]);
                  };
                  var initialState = function (i) {
                      return Control_Comonad_Store.store(i.render)({
                          items: i.items,
                  ...
                  var $$eval = function (v) {
                      if (v instanceof HandleContainer) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 187, column 36 - line 202, column 17: " + [ v.value0.constructor.name ]);
                      };
                      if (v instanceof HandleSearch) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v1) {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 216, column 21 - line 223, column 24: " + [ v1.value1.items.constructor.name ]);
                                      })())(function (v2) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 204, column 33 - line 228, column 17: " + [ v.value0.constructor.name ]);
                      };
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 186, column 12 - line 249, column 15: " + [ v.constructor.name ]);
                  };
                  ...
                  return function (renderItem) {
                      return function (st) {
                          var unpack = function (v) {
                              ...
                              throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 126, column 5 - line 126, column 27: " + [ v.constructor.name ]);
                          };
                          var renderSelections = (function () {
                              ...
                              throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 132, column 7 - line 151, column 12: " + [ st.selections.constructor.name ]);
                          })();
  ...
  var component = function (dictMonadAff) {
      var replaceItems = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at UIGuide.Components.TextFields line 98, column 5 - line 98, column 31: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
      var render = function (st) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 91, column 49 - line 95, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 79, column 5 - line 79, column 79: " + [ v.constructor.name ]);
      };
