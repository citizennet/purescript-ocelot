          ...
          if (v instanceof HandleContainer) {
              ...
              if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $11.selection = new Data_Maybe.Just(v.value0.value0);
                      return $11;
                  }))(function () {
              ...
              throw new Error("Failed pattern match at CN.UI.Dropdown line 102, column 30 - line 118, column 17: " + [ v.value0.constructor.name ]);
          };
          throw new Error("Failed pattern match at CN.UI.Dropdown line 97, column 12 - line 118, column 17: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("mw6 mw7-ns center pa2 ph4-ns black-80 sans-serif") ])([ title, introduction, mountWith("Text Field")("Captures string input.")(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(CN_UI_Dropdown.component(Data_Eq.eqString))({
              items: containerData,
              itemHTML: function (i) {
                  return [ Halogen_HTML_Core.text(i) ];
              }
          })(Halogen_HTML_Events.input(HandleDropdown.create))), mountWith("Typeahead")("Captures string input and produces a menu.")(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(CN_UI_Typeahead.component)({
              items: containerData
          })(Data_Void.absurd)) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Base.Component line 76, column 5 - line 76, column 58: " + [ v.constructor.name ]);
      };
