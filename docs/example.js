...
(function(exports) {
  ...
  var functorSyncMethod = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 112, column 8 - line 112, column 69: " + [ m.constructor.name ]);
      };
  });
          ...
          return function (item) {
              return function (items) {
                  return function (selections) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 283, column 36 - line 285, column 70: " + [ selections.constructor.name ]);
                  };
              };
          };
      };
          ...
          return function (item) {
              return function (items) {
                  return function (selections) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 296, column 36 - line 299, column 63: " + [ selections.constructor.name ]);
                  };
              };
          };
      };
  ...
  var ordPrimitiveSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 86, column 8 - line 86, column 45: " + [ x.constructor.name, y.constructor.name ]);
      };
  });                                                                                               
      ...
      return function (insertable) {
          return function (text) {
              return function (items) {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 271, column 41 - line 274, column 57: " + [ insertable.constructor.name ]);
              };
          };
      };
  };
      ...
      return function (filterType) {
          return function (text) {
              return function (items) {
                  ...
                  throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 263, column 37 - line 268, column 63: " + [ filterType.constructor.name ]);
              };
          };
      };
  };
          ...
          return function (dictEq) {
              return function (dictShow) {
                  ...
                  var updateContainer = function (v) {
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 238, column 5 - line 238, column 63: " + [ v.constructor.name ]);
                  };
                  var initialState = function (i) {
                      return Control_Comonad_Store.store(i.render)({
                          items: i.items,
                  ...
                  var $$eval = function (v) {
                      if (v instanceof HandleContainer) {
                          ...
                          if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v3) {
                                      ...
                                      $91.items = v2.value0;
                                      $91.selections = v2.value1;
                                      return $91;
                                  })))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(updateContainer(v2.value0))(function (v3) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(SearchSlot.value)(Halogen_Query.action(Select_Primitives_Search.TextInput.create(""))))(function (v4) {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 174, column 36 - line 189, column 17: " + [ v.value0.constructor.name ]);
                      };
                      if (v instanceof HandleSearch) {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          if (v1.value1.items instanceof Async) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Async.create(v1.value1.items.value0)(Data_Functor.map(Network_RemoteData.functorRemoteData)(function ($147) {
                                                  return applyI(applyF($147));
                                          ...
                                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 203, column 21 - line 210, column 24: " + [ v1.value1.items.constructor.name ]);
                                      })())(function (v2) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 191, column 33 - line 215, column 17: " + [ v.value0.constructor.name ]);
                      };
                      ...
                      throw new Error("Failed pattern match at CN.UI.Core.Typeahead line 173, column 12 - line 236, column 15: " + [ v.constructor.name ]);
                  };
...
(function(exports) {
              ...
              return function (renderItem) {
                  return function (st) {
                      var unpack = function (v) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 145, column 5 - line 145, column 27: " + [ v.constructor.name ]);
                      };
                      var renderSelections = (function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 150, column 7 - line 167, column 12: " + [ st.selections.constructor.name ]);
                      })();
          ...
          return function (highlightIndex) {
              return function (itemIndex) {
                  return function (item) {
                      if (v === "") {
                          var hover = (function () {
                              var $40 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                              if ($40) {
                                  return " bg-grey-lighter";
                              };
                              return "";
                      ...
                      var hover = (function () {
                          var $41 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                          if ($41) {
                              return " bg-grey-lighter";
                          };
                          return "";
  ...
  var testAsyncMulti$prime = function (dictMonadAff) {
      return function (dictCompareToString) {
          return function (dictEq) {
              return function (dictShow) {
...
(function(exports) {
  ...
  var loadFromSource = function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 91, column 49 - line 97, column 32: " + [ v.speed.constructor.name ]);
  };
  var load = function (v) {
      if (v instanceof CN_UI_Core_Typeahead.Sync) {
      ...
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 80, column 1 - line 82, column 83: " + [ v.constructor.name ]);
  };
  ...
  var compareToStringItem = new CN_UI_Core_Typeahead.CompareToString(function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 33, column 1 - line 33, column 53: " + [ v.constructor.name ]);
  });
  exports["Users"] = Users;
  exports["Todos"] = Todos;
  exports["Fast"] = Fast;
...
(function(exports) {
  ...
  // HTML
  var css = function ($59) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($59));
  };
  ...
  var cnDocumentationBlocks = function (dictMonadAff) {
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(radioBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(inputBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(formInputBlock(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockUsers(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockTodos(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dropdownBlock(dictMonadAff))(buttonBlock(dictMonadAff)))))));
  };
  var component = function (dictMonadAff) {
      var replaceItems = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at UIGuide.Components.TextFields line 107, column 5 - line 107, column 31: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 100, column 49 - line 104, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 88, column 5 - line 88, column 91: " + [ v.constructor.name ]);
      };
      return Halogen_Component.parentComponent(Data_Either.ordEither(ordTypeaheadSlot)(Data_Either.ordEither(Data_Ord.ordUnit)(Data_Ord.ordVoid)))({
