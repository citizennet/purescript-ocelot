...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var cnInput = "cn-input";
  var input = function (iprops) {
      return Halogen_HTML_Elements.input(Data_Semigroup.append(Data_Semigroup.semigroupArray)(iprops)([ Halogen_HTML_Properties.class_(cnInput) ]));
  };
  exports["input"] = input;
