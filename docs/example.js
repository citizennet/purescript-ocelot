...
(function(exports) {
  ...
  var renderContainer = function (st) {
      var renderToggle = Halogen_HTML_Elements.span(Select_Dispatch.getToggleProps([  ]))([ Halogen_HTML_Core.text("Toggle") ]);
      ...
      var renderItem = function (index) {
          return function (item) {
              return Halogen_HTML_Elements.li(Select_Dispatch.getItemProps(index)([  ]))([ Halogen_HTML_Core.text(item) ]);
          };
      };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v.value0 instanceof Select_Primitive_Container.ItemSelected) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Console.log("Selected: " + v.value0.value0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $8.selections = Data_Array.cons(v.value0.value0)(st.selections);
                      return $8;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Dispatch.Container.create(Select_Dispatch.ContainerReceiver.create({
                              render: renderContainer,
                              items: Data_Array.difference(Data_Eq.eqString)(v1.items)(v1.selections)
                          })))))(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          throw new Error("Failed pattern match at CN.UI.Dropdown line 89, column 30 - line 103, column 18: " + [ v.value0.constructor.name ]);
      };
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (st) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("mw6 mw7-ns center pa2 ph4-ns black-80 sans-serif") ])([ title, introduction, mountWith("Text Field")("Captures string input.")(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(CN_UI_Dropdown.component)({
              items: containerData
          })(Data_Void.absurd)), mountWith("Typeahead")("Captures string input and produces a menu.")(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(CN_UI_Typeahead.component)({
              items: containerData
          })(Data_Void.absurd)) ]);
      };
      var $$eval = function (v) {
