...
(function(exports) {
  ...
  var switchBlock = documentationBlock("switch")("some toggle switch shit")(Halogen_HTML_Elements.div_([ CN_UI_Block_Toggle.toggle([  ]) ]));
  ...
  var cnDocumentationBlocks = Data_Semigroup.append(Data_Semigroup.semigroupArray)(switchBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(radioBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(inputBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(formInputBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dropdownBlock)(buttonBlock))))));
  var component = (function () {
      var render = function (st) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 72, column 49 - line 74, column 102: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 69, column 5 - line 69, column 82: " + [ v.constructor.name ]);
      };
