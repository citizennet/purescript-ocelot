...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var spanClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "after:absolute", "after:all-02s-ease", "after:bg-grey-darkest", "after:block", "after:h-4", "after:no-content", "after:pin-l", "after:rounded-lg", "after:w-4", "before:absolute", "before:all-02s-ease", "before:no-content", "before:", "bg-grey-light", "items-center", "flex", "h-3", "relative", "rounded-lg", "w-8" ]);
