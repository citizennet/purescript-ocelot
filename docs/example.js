...
(function(exports) {
  ...
  var cnDocumentationBlocks = Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlock)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dropdownBlock)(buttonBlock));
  var component = (function () {
      var render = function (st) {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 65, column 5 - line 65, column 82: " + [ v.constructor.name ]);
      };
