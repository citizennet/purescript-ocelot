              ...
              return function (renderItem) {
                  return function (st) {
                      var unpack = function (v) {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 201, column 5 - line 201, column 27: " + [ v.constructor.name ]);
                      };
                      var renderSelections = (function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 206, column 7 - line 231, column 12: " + [ st.selections.constructor.name ]);
                      })();
          ...
          return function (highlightIndex) {
              return function (itemIndex) {
                  return function (item) {
                      if (v === "") {
                          var hover = (function () {
                              var $66 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                              if ($66) {
                                  return " bg-grey-lighter";
                              };
                              return "";
                      ...
                      var hover = (function () {
                          var $67 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(highlightIndex)(new Data_Maybe.Just(itemIndex));
                          if ($67) {
                              return " bg-grey-lighter";
                          };
                          return "";
...
(function(exports) {
  ...
  var showGroup = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.App line 62, column 1 - line 62, column 33: " + [ v.constructor.name ]);
  });
  ...
  var ordGroup = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at UIGuide.App line 61, column 8 - line 61, column 38: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
...
(function(exports) {
  ...
  var ordTypeaheadSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 60, column 8 - line 60, column 54: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var css = function ($67) {
      return Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName($67));
  };
  ...
  var cnDocumentationBlocks = function (dictMonadAff) {
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockStrings(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockUsers(dictMonadAff))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(typeaheadBlockTodos(dictMonadAff))(dropdownBlock(dictMonadAff))));
  };
  var component = function (dictMonadAff) {
      var replaceItems = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at UIGuide.Components.TextFields line 109, column 5 - line 109, column 31: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
      var render = function (st) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 102, column 49 - line 106, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 84, column 5 - line 84, column 91: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var groups = [ UIGuide_App.Components.value, UIGuide_App.FormElements.value ];
