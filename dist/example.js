...
(function(exports) {
  ...
  var typeaheadBlockTodos = function (dictMonadAff) {
      var slot = Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(CN_UI_Core_Typeahead.component(dictMonadAff)(UIGuide_Utilities_Async.eqTodo)(Data_Show.showString))(CN_UI_Components_Typeahead.defContAsyncMulti(dictMonadAff)(UIGuide_Utilities_Async.eqTodo)(Data_Show.showString)(UIGuide_Utilities_Async.todos)(UIGuide_Utilities_Async.renderItemTodo))(Halogen_HTML_Events.input(HandleTypeahead.create(Data_Unit.unit)));
