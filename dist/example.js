...
(function(exports) {
  ...
  var Fundamental = (function () {
      ...
      Fundamental.value = new Fundamental();
      return Fundamental;
  })();
  ...
  var eqGroup = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Primitive && y instanceof Primitive) {
              return true;
          };
          if (x instanceof Fundamental && y instanceof Fundamental) {
              return true;
          };
          return false;
      };
...
(function(exports) {
  ...
  var routes = Data_Map.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("textfields", {
      ...
      group: UIGuide_App.Primitive.value
      ...
      group: UIGuide_App.Fundamental.value
  }) ]);
  var groups = [ UIGuide_App.Primitive.value, UIGuide_App.Fundamental.value ];
