...
(function(exports) {
  ...
  var button = function (v) {
      return function (iprops) {
          return Halogen_HTML_Elements.button(Ocelot_Core_Utils.appendIProps(iprops)([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)(buttonTypeClasses(v.type_))(buttonClasses)) ]));
      };
  };
...
(function(exports) {
  ...
  var Ocelot_Core_Utils = PS["Ocelot.Core.Utils"];
  var Prelude = PS["Prelude"];        
  var headerClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "mb-4", "font-medium", "text-black-20", "text-lg", "flex", "items-center" ]);
  var header = function (iprops) {
      return function (html) {
          return Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.h3(Ocelot_Core_Utils.appendIProps([ Halogen_HTML_Properties.classes(headerClasses) ])(iprops))(html) ]);
      };
  };
  var header_ = header([  ]);
  var cardClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "bg-white", "h-auto", "w-full", "p-6", "shadow", "w-auto", "mb-10" ]);
  var card = function (iprops) {
      return function (html) {
          return Halogen_HTML_Elements.aside(Ocelot_Core_Utils.appendIProps([ Halogen_HTML_Properties.classes(cardClasses) ])(iprops))(html);
      };
  };
  var card_ = card([  ]);
  ...
  var card = (function () {
      var render = function (v) {
          ...
          return Halogen_HTML_Elements.div_([ UIGuide_Block_Documentation.documentation({
              ...
              title: "Card"
          })([ Ocelot_Block_Card.card_([ Ocelot_Block_Card.header_([ Halogen_HTML_Core.text("Summary") ]), meta ]) ]) ]) ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
...
(function(exports) {
  ...
  var helpTextClasses = Data_Semigroup.append(Data_Semigroup.semigroupArray)(Ocelot_Block_Type.mutedClasses)(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "block", "pt-2", "leading-normal" ]));
  var formControlClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "w-full", "mb-10" ]);
  var errorTextClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "block", "text-red", "font-bold", "pt-2" ]);
  var helpText = function (errors) {
      return function (help) {
          return Halogen_HTML_Elements.div_([ (function () {
              if (errors instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(errorTextClasses) ])(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(Ocelot_Core_Validation.htmlE(errors.value0)));
              };
              if (errors instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Core.text("");
              };
              throw new Error("Failed pattern match at Ocelot.Block.FormControl line 98, column 5 - line 103, column 3: " + [ errors.constructor.name ]);
          })(), (function () {
              if (help instanceof Data_Maybe.Just) {
                  return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(helpTextClasses) ])([ Halogen_HTML_Core.text(help.value0) ]);
              };
              if (help instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Core.text("");
              };
              throw new Error("Failed pattern match at Ocelot.Block.FormControl line 103, column 5 - line 108, column 3: " + [ help.constructor.name ]);
          })() ]);
      };
  };
  var fieldset = function (props) {
      return function (html) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(formControlClasses) ])([ Halogen_HTML_Elements.fieldset([  ])([ Halogen_HTML_Elements.legend([ Halogen_HTML_Properties.class_("w-full") ])([ label(props.label) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("my-1") ])([ html ]), helpText(props.valid)(props.helpText) ]) ]);
      };
  };
...
(function(exports) {
  ...
  var icon = function (className) {
      return function (iprops) {
          return Halogen_HTML_Elements.span([ Halogen_HTML_Properties_ARIA.label(className), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "pr-2", "inline-block" ])) ])([ Halogen_HTML_Elements.span(Ocelot_Core_Utils.appendIProps(iprops)([ Halogen_HTML_Properties_ARIA.hidden("true"), Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ className ])) ]))([  ]) ]);
      };
  };
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var tabTextClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "text-sm", "tracking-wide", "uppercase", "bold", "inline-flex", "self-end" ]);
  var tabClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "pt-5", "pb-6", "inline-flex", "no-underline" ]);
  ...
  var errorIconClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "text-2xl", "text-red", "mr-1", "inline-flex", "align-bottom" ]);
      ...
      return function (activePage) {
          return function (tab) {
              ...
              var errorIcon = (function () {
                  if (tab.errors > 0 && isActive === false) {
                      return [ Ocelot_Block_Icon.error([ Halogen_HTML_Properties.classes(errorIconClasses) ]) ];
                  };
                  if (Data_Boolean.otherwise) {
                      return [  ];
                  };
                  throw new Error("Failed pattern match at Ocelot.Block.NavigationTab line 122, column 5 - line 122, column 37: " + [  ]);
              })();
              var conditionalTabClasses = function (v) {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Block.NavigationTab line 130, column 5 - line 130, column 60: " + [ v.constructor.name ]);
              };
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("mr-12") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(tab.link), Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)(tabClasses)(conditionalTabClasses(isActive))) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(errorIcon)([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(tabTextClasses) ])([ Halogen_HTML_Core.text(tab.name) ]) ])) ]);
          };
      };
  };
...
(function(exports) {
  ...
  var formHeader = function (props) {
      return Halogen_HTML_Elements.header([ Halogen_HTML_Properties.classes(outerClasses) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(innerClasses) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)((function () {
          ...
          return [  ];
      })())(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.class_("flex-1 font-medium") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("text-lg text-grey-70 mr-4") ])(props.name), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("text-lg text-white") ])(props.title) ]) ])(props.buttons))) ]);
  };
  exports["outerClasses"] = outerClasses;
  exports["innerClasses"] = innerClasses;
...
(function(exports) {
  ...
  var labelClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "flex", "flex-row", "items-center", "inline-block", "py-1", "cursor-pointer", "leading-loose", "text-black" ]);
  var inputClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "checked:sibling:bg-blue-88", "checked:sibling:pl-4", "not:checked:sibling:bg-grey-light", "not:checked:sibling:pr-4", "offscreen" ]);
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ UIGuide_Block_Documentation.documentation({
              ...
              name: [ Halogen_HTML_Core.text("Campaign Group") ],
              title: [ Halogen_HTML_Core.text("New") ],
              brand: Data_Maybe.Nothing.value,
              buttons: [ Ocelot_Block_Button.button({
                  type_: Ocelot_Block_Button.Transparent.value
              })([ Halogen_HTML_Properties.class_("mr-2") ])([ Halogen_HTML_Core.text("Cancel") ]), Ocelot_Block_Button.button({
                  type_: Ocelot_Block_Button.Primary.value
              })([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input(HandleFormHeaderClick.create)) ])([ Halogen_HTML_Core.text("Create") ]) ]
          ...
          })([ Ocelot_Block_Card.card_([ Ocelot_Block_Card.header_([ Ocelot_Block_Icon.tip([ Halogen_HTML_Properties.class_("text-yellow text-2xl") ]), Halogen_HTML_Core.text("Accessibility Note") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Make sure to use "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("FormControl.fieldset") ]), Halogen_HTML_Core.text(" instead of "), Halogen_HTML_Elements.code_([ Halogen_HTML_Core.text("FormControl.formControl") ]), Halogen_HTML_Core.text(" with groups of radios and checkboxes.") ]) ]), Ocelot_Block_FormControl.fieldset({
              label: "Platform",
              inputId: "radio",
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.FormControl line 50, column 12 - line 61, column 15: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
  ...
  var boldMatches = function (key) {
      return function (v) {
          var boldMatch = function (v1) {
              ...
              throw new Error("Failed pattern match at Ocelot.Block.ItemContainer line 148, column 5 - line 148, column 39: " + [ v1.constructor.name ]);
          };
...
(function(exports) {
  ...
  var unpackSelections = function (v) {
      ...
      throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 373, column 1 - line 373, column 61: " + [ v.constructor.name ]);
  };
  var unpackSelection = function (v) {
      ...
      throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 368, column 1 - line 368, column 60: " + [ v.constructor.name ]);
  }; 
      ...
      return function (insertable) {
          return function (text) {
              return function (items) {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 338, column 47 - line 341, column 65: " + [ insertable.constructor.name ]);
              };
          };
      };
  };
  var applyFilter = function (filterType) {
      return function (text) {
          return function (items) {
              ...
              throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 330, column 37 - line 333, column 69: " + [ filterType.constructor.name ]);
          };
      };
  };
  var getNewItems = function (dictEq) {
      return function (st) {
          ...
          return Data_Functor.map(Network_RemoteData.functorRemoteData)(function ($147) {
              return Data_Array.sort(Data_Fuzzy.ordFuzzy(dictEq))(applyF(applyI(fuzzyItems($147))));
          ...
          return function (dictShow) {
              ...
              var $$eval = function (v) {
                  if (v instanceof HandleSelect) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              var selections = (function () {
                                  ...
                                  if (v1.value1.selections instanceof Limit) {
                                      var $68 = Data_Array.length(v1.value1.selections.value1) >= v1.value1.selections.value0;
                                      if ($68) {
                                  ...
                                  throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 232, column 28 - line 235, column 92: " + [ v1.value1.selections.constructor.name ]);
                              })();
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  var $71 = {};
                                  for (var $72 in v2) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      if (v1.value1.config.syncMethod instanceof Async) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                              ...
                                              $84.items = Network_RemoteData.Loading.value;
                                              return $84;
                                          })))(function () {
                                      ...
                                      throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 250, column 11 - line 255, column 56: " + [ v1.value1.config.syncMethod.constructor.name ]);
                                  })())(function () {
                      ...
                      throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 226, column 33 - line 262, column 17: " + [ v.value0.constructor.name ]);
                  };
                  if (v instanceof Remove) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          var selections = (function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 268, column 26 - line 271, column 60: " + [ v1.value1.selections.constructor.name ]);
                          })();
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              var $105 = {};
                              for (var $106 in v2) {
                  ...
                  if (v instanceof Synchronize) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 286, column 14 - line 297, column 61: " + [ v2.constructor.name ]);
                          })())(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
                      });
                  ...
                  if (v instanceof Reset) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          var selections = (function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 312, column 26 - line 315, column 32: " + [ v1.value1.selections.constructor.name ]);
                          })();
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              var $139 = {};
                              for (var $140 in v2) {
                              ...
                              $139.items = Network_RemoteData.NotAsked.value;
                              return $139;
                          })))(function () {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 225, column 12 - line 321, column 15: " + [ v.constructor.name ]);
              };
                  ...
                  return function (renderSelectionItem) {
                      return function (st) {
                          ...
                          var renderContainer_ = (function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 268, column 5 - line 270, column 38: " + [  ]);
                          })();
                          var selectInput = {
                              ...
                              debounceTime: (function () {
                                  ...
                                  throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 230, column 23 - line 232, column 29: " + [ st.config.syncMethod.constructor.name ]);
                              })(),
...
(function(exports) {
  ...
  var renderItemTodo = {
      ...
      renderContainer: Ocelot_Components_Typeahead["defRenderContainer'"](function ($65) {
