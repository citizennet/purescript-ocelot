...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var inputRightClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "border-l", "ml-1", "px-3", "cursor-pointer", "self-center" ]);
  ...
  var inputInnerClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "cc-blue-88", "disabled:bg-grey-light", "focus:no-outline", "px-4", "py-3", "rounded-sm", "flex-auto" ]);
  ...
  exports["inputRightClasses"] = inputRightClasses;
  exports["input"] = input;
...
(function(exports) {
  ...
  var ContainerClicked = (function () {
      ...
      ContainerClicked.value = new ContainerClicked();
      return ContainerClicked;
  })();
  var VisibilitySet = (function () {
      function VisibilitySet(value0) {
          this.value0 = value0;
      };
      VisibilitySet.create = function (value0) {
          return new VisibilitySet(value0);
      };
  ...
  var getToggleProps = function (q) {
      return Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray))([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(q(Halogen_Query.action(ToggleVisibility.create)))), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(function (ev) {
  ...
  var getItemProps = function (index) {
      return Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray))([ Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input_(Select.create(index))), Halogen_HTML_Events.onMouseOver(Halogen_HTML_Events.input_(Highlight.create(new Index(index)))), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(Key.create)), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(Blur.create)) ]);
  };
  var getContainerProps = Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray))([ Halogen_HTML_Events.onMouseDown(Halogen_HTML_Events.input_(Mouse.create(Down.value))), Halogen_HTML_Events.onMouseUp(Halogen_HTML_Events.input_(Mouse.create(Up.value))) ]);
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof Highlight) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                      ...
                      throw new Error("Failed pattern match at Select.Primitives.Container line 179, column 46 - line 193, column 67: " + [ v.value0.constructor.name ]);
                  })());
              });
          };
          if (v instanceof Key) {
                  ...
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)((function () {
                      ...
                      if (v.value0 instanceof Up) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              ...
                              return Halogen_Query_HalogenM.raise(ContainerClicked.value);
                          });
                      };
                      throw new Error("Failed pattern match at Select.Primitives.Container line 218, column 21 - line 222, column 39: " + [ v.value0.constructor.name ]);
                  })());
              });
          };
          if (v instanceof Blur) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var $84 = !v1.value1.open || v1.value1.mouseDown;
                  if ($84) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  };
              ...
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  ...
                  if (v.value0 instanceof Off) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v1) {
                          ...
                          $92.open = false;
                          $92.highlightedIndex = Data_Maybe.Nothing.value;
                          return $92;
                      }));
                  };
                  throw new Error("Failed pattern match at Select.Primitives.Container line 232, column 9 - line 234, column 83: " + [ v.value0.constructor.name ]);
              })())(function () {
                  return Halogen_Query_HalogenM.raise(new VisibilitySet(v.value0));
              }));
          };
          if (v instanceof ToggleVisibility) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  if (!v1.value1.open) {
                      return $$eval(new SetVisibility(On.value, Data_Unit.unit));
                  };
                  return $$eval(new SetVisibility(Off.value, Data_Unit.unit));
              }));
          };
          ...
          throw new Error("Failed pattern match at Select.Primitives.Container line 160, column 12 - line 251, column 49: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState,
  ...
  exports["ContainerClicked"] = ContainerClicked;
  exports["VisibilitySet"] = VisibilitySet;
  exports["Emit"] = Emit;
  exports["component"] = component;
...
(function(exports) {
  ...
  var getInputProps = Data_Function.flip(Data_Semigroup.append(Data_Semigroup.semigroupArray))([ Halogen_HTML_Events.onFocus(Halogen_HTML_Events.input(CaptureFocus.create)), Halogen_HTML_Events.onKeyDown(Halogen_HTML_Events.input(function ($61) {
      return FromContainer.create(Halogen_Query.action(Select_Primitives_Container.Key.create($61)));
  })), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(TextInput.create)), Halogen_HTML_Events.onBlur(Halogen_HTML_Events.input_(FromContainer.create(Halogen_Query.action(Select_Primitives_Container.Blur.create)))), Halogen_HTML_Properties.tabIndex(0) ]);
  var component = function (dictMonadAff) {
      var initialState = function (i) {
          return Control_Comonad_Store.store(i.render)({
              ...
              inputEl: Data_Maybe.Nothing.value
          });
      };
      var $$eval = function (v) {
          if (v instanceof TextInput) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(v1.value1.ms))(function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(dictMonadAff)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff_AVar.takeVar(v2)))(function (v4) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v5) {
                                          var $25 = {};
                                          for (var $26 in v5) {
                                              if ({}.hasOwnProperty.call(v5, $26)) {
                                                  $25[$26] = v5[$26];
                                              };
                                          };
                                          $25.debouncer = Data_Maybe.Nothing.value;
                                          return $25;
                                      })))(function () {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff.killFiber(Control_Monad_Eff_Exception.error("Time's up!"))(v1.value1.debouncer.value0.fiber)))(function (v2) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Monad_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Monad_Aff.delay(v1.value1.ms))(function () {
                                  ...
                                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v4) {
                                      ...
                                      $35.debouncer = new Data_Maybe.Just({
                      ...
                      throw new Error("Failed pattern match at Select.Primitives.Search line 184, column 9 - line 210, column 67: " + [ v1.value1.debouncer.constructor.name ]);
                  });
              }));
          };
          ...
          if (v instanceof CaptureFocus) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var el = function ($62) {
                      return Data_Either.hush(Control_Monad_Except.runExcept(DOM_HTML_Types.readHTMLElement(Data_Foreign.toForeign(DOM_Event_Event.currentTarget(DOM_Event_Types.focusEventToEvent($62))))));
                  };
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                      var $50 = {};
                      for (var $51 in v2) {
                      ...
                      $50.inputEl = el(v.value0);
                      return $50;
                  })))(function () {
                      return Halogen_Query_HalogenM.raise(Focused.value);
                  });
              }));
          };
          if (v instanceof TriggerFocus) {
              return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value0)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableMaybe)(function ($63) {
                      return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadAff.MonadEff0()))(DOM_HTML_HTMLElement.focus($63));
                  })(v1.value1.inputEl);
              }));
          };
          throw new Error("Failed pattern match at Select.Primitives.Search line 179, column 12 - line 236, column 51: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: initialState,
          render: Control_Comonad.extract(Control_Comonad_Store_Trans.comonadStoreT(Data_Identity.comonadIdentity)),
...
(function(exports) {
  ...
  var ContainerMessage = (function () {
      function ContainerMessage(value0) {
          this.value0 = value0;
      };
      ContainerMessage.create = function (value0) {
          return new ContainerMessage(value0);
      };
      return ContainerMessage;
  })();
  var SearchMessage = (function () {
      function SearchMessage(value0) {
          this.value0 = value0;
      };
      SearchMessage.create = function (value0) {
          return new SearchMessage(value0);
      };
  ...
  var ToSearch = (function () {
      function ToSearch(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ToSearch.create = function (value0) {
          return function (value1) {
              return new ToSearch(value0, value1);
          };
      };
      return ToSearch;
  })();
  ...
  var inContainer = function ($30) {
      return Halogen_Query.action(ToContainer.create(Halogen_Query.action($30)));
  };
  ...
  var ordPrimitiveSlot = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at Select.Primitives.SearchContainer line 58, column 8 - line 58, column 45: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var component = function (dictMonadAff) {
      var initialState = function (i) {
          ...
          var render$prime = function (v) {
              return i.render(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(SearchSlot.value)(Select_Primitives_Search.component(dictMonadAff))(inputS)(Halogen_HTML_Events.input(HandleSearch.create)))(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(ContainerSlot.value)(Select_Primitives_Container.component(dictMonadAff))(inputC)(Halogen_HTML_Events.input(HandleContainer.create)));
          };
          return Control_Comonad_Store.store(render$prime)(Data_Unit.unit);
      };
      var $$eval = function ($copy_v) {
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(v) {
              if (v instanceof ToContainer) {
                  $tco_done = true;
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(ContainerSlot.value)(v.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              };
              if (v instanceof ToSearch) {
                  $tco_done = true;
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(SearchSlot.value)(v.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              };
              if (v instanceof HandleContainer) {
                  ...
                  if (v.value0 instanceof Select_Primitives_Container.ContainerClicked) {
                      $tco_done = true;
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(SearchSlot.value)(Halogen_Query.action(Select_Primitives_Search.TriggerFocus.create)));
                  };
                  $tco_done = true;
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Halogen_Query_HalogenM.raise(new ContainerMessage(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              };
              if (v instanceof HandleSearch) {
                  ...
                  if (v.value0 instanceof Select_Primitives_Search.ContainerQuery) {
                      $copy_v = new ToContainer(v.value0.value0, v.value1);
                      return;
                  };
                  if (v.value0 instanceof Select_Primitives_Search.Focused) {
                      $tco_done = true;
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(ContainerSlot.value)(Halogen_Query.action(Select_Primitives_Container.SetVisibility.create(Select_Primitives_Container.On.value))));
                  };
                  $tco_done = true;
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Halogen_Query_HalogenM.raise(new SearchMessage(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              };
              if (v instanceof Receiver) {
                  var searchInput = {
                      search: v.value0.search,
                      debounceTime: v.value0.debounceTime,
                      render: v.value0.renderSearch
                  };
                  var containerInput = {
                      items: v.value0.items,
                      render: v.value0.renderContainer
                  };
                  $tco_done = true;
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp1)(ContainerSlot.value)(Halogen_Query.action(Select_Primitives_Container.ContainerReceiver.create(containerInput))))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(eqPrimitiveSlot)(Data_Either.eqEither(eqPrimitiveSlot)(Data_Eq.eqVoid)))(Halogen_Component_ChildPath.cp2)(SearchSlot.value)(Halogen_Query.action(Select_Primitives_Search.SearchReceiver.create(searchInput))))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              };
              throw new Error("Failed pattern match at Select.Primitives.SearchContainer line 108, column 5 - line 116, column 12: " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
              $tco_result = $tco_loop($copy_v);
          };
      ...
      return Halogen_Component.parentComponent(Data_Either.ordEither(ordPrimitiveSlot)(Data_Either.ordEither(ordPrimitiveSlot)(Data_Ord.ordVoid)))({
          initialState: initialState,
          render: Control_Comonad.extract(Control_Comonad_Store_Trans.comonadStoreT(Data_Identity.comonadIdentity)),
          "eval": $$eval,
...
})(PS["Select.Primitives.SearchContainer"] = PS["Select.Primitives.SearchContainer"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Select_Primitives_Container = PS["Select.Primitives.Container"];
  var Select_Primitives_Search = PS["Select.Primitives.Search"];
  var Select_Primitives_SearchContainer = PS["Select.Primitives.SearchContainer"];
  var Select_Primitives_State = PS["Select.Primitives.State"];        
  var Sync = (function () {
  ...
  var HandleSearchContainer = (function () {
      function HandleSearchContainer(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleSearchContainer.create = function (value0) {
          return function (value1) {
              return new HandleSearchContainer(value0, value1);
          };
      };
      return HandleSearchContainer;
  })();
  var Remove = (function () {
  ...
  var unpackSelections = function (v) {
      ...
      throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 442, column 1 - line 442, column 61: " + [ v.constructor.name ]);
  };
  var unpackSelection = function (v) {
      ...
      throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 437, column 1 - line 437, column 60: " + [ v.constructor.name ]);
  };
          ...
          return function (items) {
              return function (selections) {
                  ...
                  if (selections instanceof Limit) {
                      var $73 = Data_Array.length(selections.value1) >= selections.value0;
                      if ($73) {
                          return selections;
                      };
                      return Limit.create(selections.value0)(Data_Array.cons(item)(selections.value1));
                  };
                  throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 398, column 36 - line 401, column 75: " + [ selections.constructor.name ]);
              };
          };
      };
  };
      ...
      return function (item) {
          return function (items) {
              return function (selections) {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 386, column 36 - line 389, column 42: " + [ selections.constructor.name ]);
              };
          };
      };
  };
  ...
  var removeSelections = function (dictEq) {
      return function (items) {
          return function (selections) {
              ...
              throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 410, column 37 - line 413, column 85: " + [ items.constructor.name ]);
          };
      };
  };
  var maybeReplaceItems = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 454, column 1 - line 457, column 47: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var functorSyncMethod = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 146, column 8 - line 146, column 69: " + [ m.constructor.name ]);
      };
  });
      ...
      return function (insertable) {
          return function (text) {
              return function (items) {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 372, column 47 - line 375, column 65: " + [ insertable.constructor.name ]);
              };
          };
      };
  };
  var applyFilter = function (filterType) {
      return function (text) {
          return function (items) {
              ...
              throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 364, column 37 - line 367, column 69: " + [ filterType.constructor.name ]);
          };
      };
  };
  var getNewItems = function (dictEq) {
      return function (st) {
          ...
          return Data_Functor.map(functorSyncMethod)(function ($224) {
              return Data_Array.sort(Data_Fuzzy.ordFuzzy(dictEq))(applyF(applyI($224)));
      ...
      return function (dictEq) {
          return function (dictShow) {
              var updateContainer = function (v) {
                  if (v instanceof Sync) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select_Primitives_SearchContainer.inContainer(Select_Primitives_Container.ReplaceItems.create(v.value0))))(function (v1) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  };
                  if (v instanceof Async && v.value1 instanceof Network_RemoteData.Success) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select_Primitives_SearchContainer.inContainer(Select_Primitives_Container.ReplaceItems.create(v.value1.value0))))(function (v1) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  };
                  if (v instanceof Async && v.value1 instanceof Network_RemoteData.Failure) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select_Primitives_SearchContainer.inContainer(Select_Primitives_Container.SetVisibility.create(Select_Primitives_Container.Off.value))))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select_Primitives_SearchContainer.inContainer(Select_Primitives_Container.ReplaceItems.create([  ]))))(function (v2) {
                  ...
                  if (v instanceof ContinuousAsync && v.value3 instanceof Network_RemoteData.Success) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select_Primitives_SearchContainer.inContainer(Select_Primitives_Container.ReplaceItems.create(v.value3.value0))))(function (v1) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  };
              ...
              var $$eval = function (v) {
                  if (v instanceof HandleSearchContainer) {
                      if (v.value0 instanceof Select_Primitives_SearchContainer.Emit) {
                          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Halogen_Query_HalogenM.raise(new Emit(v.value0.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
                      };
                      if (v.value0 instanceof Select_Primitives_SearchContainer.ContainerMessage) {
                          if (v.value0.value0 instanceof Select_Primitives_Container.ItemSelected) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                  var newSelections = selectItem(dictEq)(v.value0.value0.value0.original)(v1.value1.items)(v1.value1.selections);
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                      var $156 = {};
                                      for (var $157 in v2) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          return Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Select_Primitives_SearchContainer.inContainer(Select_Primitives_Container.SetVisibility.create(Select_Primitives_Container.Off.value)));
                                      })())(function (v2) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new SelectionsChanged(ItemSelected.value, v.value0.value0.value0.original, newSelections)))(function () {
                      ...
                      if (v.value0 instanceof Select_Primitives_SearchContainer.SearchMessage) {
                          if (v.value0.value0 instanceof Select_Primitives_Search.NewSearch) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v1) {
                                  ...
                                  $166.search = v.value0.value0.value0;
                                  return $166;
                              })))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new NewSearch(v.value0.value0.value0)))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                          if (v1.value1.items instanceof ContinuousAsync) {
                                              var cont = new ContinuousAsync(v1.value1.items.value0, v.value0.value0.value0, v1.value1.items.value2, Network_RemoteData.Loading.value);
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                                  var $171 = {};
                                                  for (var $172 in v2) {
                      ...
                      throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 237, column 42 - line 277, column 30: " + [ v.value0.constructor.name ]);
                  };
                  ...
                  if (v instanceof Initialize) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Primitives_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          ...
                          throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 304, column 9 - line 317, column 19: " + [ v1.value1.items.constructor.name ]);
                      });
                  };
                  ...
                  throw new Error("Failed pattern match at Ocelot.Core.Typeahead line 236, column 12 - line 321, column 15: " + [ v.constructor.name ]);
              };
  ...
  exports["HandleSearchContainer"] = HandleSearchContainer;
  ...
  var component = function (dictMonadAff) {
      return function (dictEq) {
          var render = function (st) {
              ...
              var renderSingleToggle = function (selected) {
                  var toggleStyle = (function () {
                      ...
                      throw new Error("Failed pattern match at Ocelot.Components.Dropdown line 168, column 27 - line 172, column 13: " + [ selected.constructor.name ]);
                  })();
                  var toggleHTML = (function () {
                      ...
                      throw new Error("Failed pattern match at Ocelot.Components.Dropdown line 173, column 26 - line 175, column 93: " + [ selected.constructor.name ]);
                  })();
              ...
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("w-full px-3") ])([ Halogen_HTML_Elements.label([ Halogen_HTML_Properties.class_("block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2") ])([ Halogen_HTML_Core.text(st.title) ]), (function () {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Components.Dropdown line 105, column 9 - line 127, column 16: " + [ st.selection.constructor.name ]);
          ...
          var $$eval = function (v) {
              ...
              if (v instanceof Removed) {
                  return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at Ocelot.Components.Dropdown line 223, column 41 - line 227, column 78: " + [ v1.selection.constructor.name ]);
                      })()))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.ReplaceItems.create(v2.value1))))(function (v3) {
                                  return Halogen_Query_HalogenM.raise(new SelectionsChanged(Ocelot_Core_Typeahead.ItemRemoved.value, v.value0, v2.value0));
                              });
                          });
                      });
                  }));
                  ...
                  if (v.value0 instanceof Select_Primitives_Container.ItemSelected) {
                      return Data_Functor.voidRight(Halogen_Query_HalogenM.functorHalogenM)(v.value1)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Components.Dropdown line 240, column 43 - line 244, column 80: " + [ v1.selection.constructor.name ]);
                          })()))(function (v2) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  var $46 = {};
                                  for (var $47 in v3) {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.ReplaceItems.create(v2.value1))))(function (v3) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          if (v1.selection instanceof Single) {
                                              return Halogen_Query.query(Data_Eq.eqUnit)(Data_Unit.unit)(Halogen_Query.action(Select_Primitives_Container.SetVisibility.create(Select_Primitives_Container.Off.value)));
                                          };
                                          if (v1.selection instanceof Multi) {
                                          ...
                                          throw new Error("Failed pattern match at Ocelot.Components.Dropdown line 249, column 16 - line 251, column 44: " + [ v1.selection.constructor.name ]);
                                      })())(function (v4) {
                                          return Halogen_Query_HalogenM.raise(new SelectionsChanged(Ocelot_Core_Typeahead.ItemSelected.value, v.value0.value0, v2.value0));
                                      });
                                  });
                              });
                          });
              ...
              throw new Error("Failed pattern match at Ocelot.Components.Dropdown line 213, column 12 - line 254, column 28: " + [ v.constructor.name ]);
          };
          return Halogen_Component.parentComponent(Data_Ord.ordUnit)({
              initialState: initialState,
              render: render,
...
(function(exports) {
  ...
  var buttonClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "float-right", "leading-normal", "invisible", "group-hover:visible" ]);
  ...
  var boldMatches = function (key) {
      return function (v) {
          var boldMatch = function (v1) {
              ...
              throw new Error("Failed pattern match at Ocelot.Block.ItemContainer line 131, column 5 - line 131, column 39: " + [ v1.constructor.name ]);
          };
  ...
  var itemContainer = function (highlightIndex) {
      return function (html) {
          ...
          return Halogen_HTML_Elements.div(Select_Primitives_Container.getContainerProps([ Halogen_HTML_Properties.classes(itemContainerClasses) ]))([ Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes(ulClasses) ])(Data_FunctorWithIndex.mapWithIndex(Data_FunctorWithIndex.functorWithIndexArray)(function (i) {
              return function (h) {
                  return Halogen_HTML_Elements.li(Select_Primitives_Container.getItemProps(i)([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)(liClasses)(hover(i))) ]))([ Halogen_HTML.fromPlainHTML(h) ]);
              };
          })(html)) ]);
      };
  };
...
(function(exports) {
                  ...
                  return function (renderSelectionItem) {
                      return function (st) {
                          var renderSearch = function (sst) {
                              return Halogen_HTML_Elements.label([ Halogen_HTML_Properties.classes(Ocelot_Block_Input.inputOuterClasses) ])([ Ocelot_Block_Input.input(Select_Primitives_Search.getInputProps(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.value(sst.search) ])(props))), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Ocelot_Block_Input.inputRightClasses)(Ocelot_Block_Type.linkClasses)) ])([ Halogen_HTML_Core.text("Browse") ]) ]);
                          };
                          ...
                          var searchContainerInput = {
                              search: Data_Maybe.Nothing.value,
                              debounceTime: (function () {
                                  if (st.items instanceof Ocelot_Core_Typeahead.ContinuousAsync) {
                              ...
                              render: function (search) {
                                  return function (container) {
                                      return Halogen_HTML_Elements.div_([ search, container ]);
                                  };
                              }
                          };
                          ...
                          var renderAll = function (slot) {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 239, column 7 - line 247, column 48: " + [ st.selections.constructor.name ]);
                          };
                          return renderAll(Halogen_HTML.slot(Data_Unit.unit)(Select_Primitives_SearchContainer.component(dictMonadAff))(searchContainerInput)(Halogen_HTML_Events.input(Ocelot_Core_Typeahead.HandleSearchContainer.create)));
                      };
                  };
              };
          };
  ...
  var defSingleConfig = function (dictEq) {
          ...
          return function (dictShow) {
              return function (props) {
                  return function (xs) {
                      return function (v) {
                          return {
                              items: new Ocelot_Core_Typeahead.Sync(xs),
                              search: Data_Maybe.Nothing.value,
                              ...
                              config: defSingleConfig(dictEq)(v.toStrMap)
                          };
                      };
                  };
              };
  ...
  var defRenderFuzzy = function ($87) {
      return Halogen_HTML_Elements.span_(Ocelot_Block_ItemContainer.boldMatches("name")($87));
  };
  ...
  var defMultiConfig = function (dictEq) {
      return function (toStrMap) {
          return {
              insertable: Ocelot_Core_Typeahead.NotInsertable.value,
              filterType: Ocelot_Core_Typeahead.FuzzyMatch.value,
                  ...
                  return function (xs) {
                      return function (v) {
                          return {
                              ...
                              render: renderTA(dictMonadAff)(dictEq)(props)(v.renderFuzzy)(v.renderItem),
                              config: defMultiConfig(dictEq)(v.toStrMap)
                          };
                      };
                  };
              };
          ...
          return function (dictShow) {
              return function (props) {
                  return function (source) {
                      return function (v) {
                          return {
                              items: new Ocelot_Core_Typeahead.Async(source, Network_RemoteData.NotAsked.value),
                              search: Data_Maybe.Nothing.value,
                              initialSelection: new Ocelot_Core_Typeahead.Many([  ]),
                              render: renderTA(dictMonadAff)(dictEq)(props)(v.renderFuzzy)(v.renderItem),
                              config: defMultiConfig(dictEq)(v.toStrMap)
          ...
          return function (dictShow) {
              return function (props) {
                  return function (source) {
                      return function (v) {
                          return {
                              items: new Ocelot_Core_Typeahead.ContinuousAsync(500.0, "", source, Network_RemoteData.NotAsked.value),
                              search: Data_Maybe.Nothing.value,
                              initialSelection: new Ocelot_Core_Typeahead.Many([  ]),
                              render: renderTA(dictMonadAff)(dictEq)(props)(v.renderFuzzy)(v.renderItem),
  ...
  exports["defContAsyncMulti"] = defContAsyncMulti;
  exports["defSingleConfig"] = defSingleConfig;
  exports["defMultiConfig"] = defMultiConfig;
...
(function(exports) {
  ...
  var renderItemUser = {
      ...
      renderItem: function ($72) {
          return Ocelot_Components_Typeahead.defRenderItem(Data_Newtype.unwrap(newtypeUser)($72));
      },
  ...
  var renderItemTodo = {
      ...
      renderItem: function ($73) {
          return Halogen_HTML_Core.text((function (v) {
              return v.title;
          })(Data_Newtype.unwrap(newtypeTodo)($73)));
      },
      renderFuzzy: function ($74) {
          return Halogen_HTML_Elements.span_(Ocelot_Block_ItemContainer.boldMatches("title")($74));
      }
  };
  ...
  var load = function (v) {
      if (v instanceof Ocelot_Core_Typeahead.Sync) {
          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(new Network_RemoteData.Success(v.value0));
      };
      if (v instanceof Ocelot_Core_Typeahead.Async) {
          return loadFromSource(v.value0);
      };
      if (v instanceof Ocelot_Core_Typeahead.ContinuousAsync) {
...
(function(exports) {
  ...
  var dropdownMultiSlot = function (dictMonadAff) {
      return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Ocelot_Components_Dropdown.component(dictMonadAff)(eqTestRecord))({
          items: dropdownData,
          itemHTML: function (i) {
              return [ Halogen_HTML_Core.text((function (v) {
                  return v.name;
          ...
          selection: new Ocelot_Components_Dropdown.Multi([  ]),
  ...
  var dropdownSingleSlot = function (dictMonadAff) {
      return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(Ocelot_Components_Dropdown.component(dictMonadAff)(eqTestRecord))({
          items: dropdownData,
          itemHTML: function (i) {
              return [ Halogen_HTML_Core.text((function (v) {
          ...
          selection: new Ocelot_Components_Dropdown.Single(Data_Maybe.Nothing.value),
  ...
  var cnDocumentationBlocks = function (dictMonadAff) {
      return Halogen_HTML_Elements.div_([ UIGuide_Block_Documentation.documentation({
          ...
          valid: Data_Maybe.Nothing.value,
          inputId: "devs"
      })(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Ocelot_Core_Typeahead.component(dictMonadAff)(Data_Eq.eqString)(Data_Void.showVoid))(Ocelot_Components_Typeahead.defMulti(dictMonadAff)(Data_Eq.eqString)(Data_Void.showVoid)([ Halogen_HTML_Properties.placeholder("Search developers..."), Halogen_HTML_Properties.id_("devs") ])(containerData)(Ocelot_Components_Typeahead.renderItemString))(Halogen_HTML_Events.input(HandleSyncTypeahead.create))) ]), UIGuide_Block_Component.component({
          ...
          valid: Data_Maybe.Nothing.value,
          inputId: "devs-async"
      })(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Ocelot_Core_Typeahead.component(dictMonadAff)(UIGuide_Utilities_Async.eqTodo)(Data_Show.showString))(Ocelot_Components_Typeahead.defContAsyncMulti(dictMonadAff)(UIGuide_Utilities_Async.eqTodo)(Data_Show.showString)([ Halogen_HTML_Properties.placeholder("Search developers asynchronously..."), Halogen_HTML_Properties.id_("devs-async") ])(UIGuide_Utilities_Async.todos)(UIGuide_Utilities_Async.renderItemTodo))(Halogen_HTML_Events.input(HandleTypeahead.create(Data_Unit.unit)))) ]) ]), UIGuide_Block_Documentation.documentation({
          header: "Dropdowns",
          ...
          label: "Platforms",
          helpText: new Data_Maybe.Just("There are lots of platforms to choose from."),
          valid: Data_Maybe.Nothing.value,
          inputId: ""
          ...
          label: "Lorem Ipsum",
          helpText: new Data_Maybe.Just("Dolor sit amet consectectuer."),
          valid: Data_Maybe.Nothing.value,
          inputId: ""
  ...
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleTypeahead) {
              if (v.value1 instanceof Ocelot_Core_Typeahead.RequestData) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(UIGuide_Utilities_Async.load(v.value1.value0)))(function (v1) {
                      var v2 = Ocelot_Core_Typeahead.maybeReplaceItems(v1)(v.value1.value0);
                      if (v2 instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                      };
                      if (v2 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid))))(Halogen_Component_ChildPath.cp1)(v.value0)(Halogen_Query.action(Ocelot_Core_Typeahead.FulfillRequest.create(v2.value0))))(function (v3) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                          });
                      };
                      throw new Error("Failed pattern match at UIGuide.Components.TextFields line 85, column 9 - line 89, column 22: " + [ v2.constructor.name ]);
                  });
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
          };
  ...
  exports["dropdownSingleSlot"] = dropdownSingleSlot;
  exports["dropdownMultiSlot"] = dropdownMultiSlot;
...
(function(exports) {
  ...
  var validateUsername = function (uname) {
      return Data_Bifunctor.bimap(Data_Validation_Semigroup.bifunctorV)(Data_Map.singleton(FailUsername.value))(function ($135) {
          return Username(Data_String_Utils.fromCharArray($135));
  ...
  var validateDevelopers = function ($136) {
      return Data_Bifunctor.lmap(Data_Validation_Semigroup.bifunctorV)(Data_Map.singleton(FailDevelopers.value))(Ocelot_Core_Validation.validateNonEmptyMaybe($136));
  };
  var validateField = function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.Components.Validation line 308, column 1 - line 308, column 47: " + [ v.constructor.name ]);
  };
  ...
  var renderItemTestRecord = {
      ...
      renderFuzzy: Ocelot_Components_Typeahead.defRenderFuzzy,
      renderItem: function ($137) {
          return Ocelot_Components_Typeahead.defRenderItem(Data_Newtype.unwrap(newtypeTestRecord)($137));
      }
  };         
  var eqTestRecord = new Data_Eq.Eq(function (v) {
      return function (v1) {
  ...
  var ordFormErrorKey = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.Validation line 288, column 8 - line 288, column 52: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var renderForm = function (dictMonadAff) {
      return function (st) {
          return Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(Halogen_HTML_Events.input_(FormSubmit.create)) ])([ UIGuide_Block_Documentation.documentation({
              ...
              inputId: "devs"
          })(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Ocelot_Core_Typeahead.component(dictMonadAff)(eqTestRecord)(Data_Void.showVoid))(Ocelot_Components_Typeahead.defSingle(dictMonadAff)(eqTestRecord)(Data_Void.showVoid)([ Halogen_HTML_Properties.placeholder("Search developers..."), Halogen_HTML_Properties.id_("devs") ])(testRecords)(renderItemTestRecord))(Halogen_HTML_Events.input(HandleA.create))), Ocelot_Block_FormControl.formControl({
              label: "Todos",
              ...
              inputId: "users1"
          })(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Ocelot_Core_Typeahead.component(dictMonadAff)(UIGuide_Utilities_Async.eqUser)(Data_Show.showString))(Ocelot_Components_Typeahead.defContAsyncMulti(dictMonadAff)(UIGuide_Utilities_Async.eqUser)(Data_Show.showString)([ Halogen_HTML_Properties.placeholder("Search users asynchronously"), Halogen_HTML_Properties.id_("users1") ])(UIGuide_Utilities_Async.users)(UIGuide_Utilities_Async.renderItemUser))(Halogen_HTML_Events.input(HandleC.create))), Ocelot_Block_FormControl.formControl({
              label: "Users 2",
              helpText: new Data_Maybe.Just("Honestly, this is just lazy."),
              valid: Data_Map.lookup(ordFormErrorKey)(FailUsers2.value)(st.errors),
              inputId: "users2"
          })(Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp4)(Data_Unit.unit)(Ocelot_Core_Typeahead.component(dictMonadAff)(UIGuide_Utilities_Async.eqUser)(Data_Show.showString))(Ocelot_Components_Typeahead.defAsyncMulti(dictMonadAff)(UIGuide_Utilities_Async.eqUser)(Data_Show.showString)([ Halogen_HTML_Properties.placeholder("Search more users..."), Halogen_HTML_Properties.id_("users2") ])(UIGuide_Utilities_Async.users)(UIGuide_Utilities_Async.renderItemUser))(Halogen_HTML_Events.input(HandleD.create))), Ocelot_Block_FormControl.formControl({
              label: "Email",
              helpText: new Data_Maybe.Just("Dave will spam your email with gang of four patterns"),
      ...
      var load = function (cp) {
          return function (m) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(UIGuide_Utilities_Async.load(m)))(function (v) {
                  var v1 = Ocelot_Core_Typeahead.maybeReplaceItems(v)(m);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))))(cp)(Data_Unit.unit)(Halogen_Query.action(Ocelot_Core_Typeahead.FulfillRequest.create(v1.value0))))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  };
                  throw new Error("Failed pattern match at UIGuide.Components.Validation line 170, column 7 - line 174, column 21: " + [ v1.constructor.name ]);
              });
          };
      };
      var $$eval = function (v) {
          ...
          if (v instanceof HandleB) {
              if (v.value0 instanceof Ocelot_Core_Typeahead.RequestData) {
          ...
          if (v instanceof UpdateTextField) {
              if (v.value0 === 1) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $101.raw = (function () {
                          var $98 = {};
                          for (var $99 in v1.raw) {
                              if ({}.hasOwnProperty.call(v1.raw, $99)) {
                                  $98[$99] = v1["raw"][$99];
                              };
                          };
                          $98.email = v.value1;
              ...
              if (v.value0 === 2) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $107.raw = (function () {
                          var $104 = {};
                          for (var $105 in v1.raw) {
                              if ({}.hasOwnProperty.call(v1.raw, $105)) {
                                  $104[$105] = v1["raw"][$105];
                              };
                          };
                          $104.username = v.value1;
                          return $104;
                      })();
                      return $107;
                  }))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2));
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))))(Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Halogen_Query.request(Ocelot_Core_Typeahead.Selections.create)))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))))(Halogen_Component_ChildPath.cp4)(Data_Unit.unit)(Halogen_Query.request(Ocelot_Core_Typeahead.Selections.create)))(function (v4) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                  ...
                                  $127.raw = (function () {
                                      var $124 = {};
                                      for (var $125 in v5.raw) {
                                          if ({}.hasOwnProperty.call(v5.raw, $125)) {
                                              $124[$125] = v5["raw"][$125];
                                          };
                                      };
                                      $124.developers = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Ocelot_Core_Typeahead.unpackSelection)(v1);
                                      $124.todos = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(Ocelot_Core_Typeahead.unpackSelections)(v2));
                                      $124.users1 = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(Ocelot_Core_Typeahead.unpackSelections)(v3));
                                      $124.users2 = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(Ocelot_Core_Typeahead.unpackSelections)(v4));
                                      return $124;
                                  })();
                                  return $127;
                              }))(function () {
