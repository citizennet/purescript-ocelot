...
(function(exports) {
  ...
  var getField = function (dictDecodeJson) {
      return function (o) {
          return function (s) {
              return Data_Maybe.maybe(Data_Either.Left.create("Expected field " + Data_Show.show(Data_Show.showString)(s)))(Data_Argonaut_Decode_Class.decodeJson(dictDecodeJson))(Foreign_Object.lookup(s)(o));
          };
      };
  };
...
(function(exports) {
  ...
  var partitionByGroup = function (g) {
      return function ($38) {
          return Data_Tuple.Tuple.create(g)(Data_Map_Internal.filter(Data_Ord.ordString)(function (v) {
...
(function(exports) {
  ...
  var unpackSelections = function (v) {
      ...
      throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 347, column 1 - line 347, column 61: " + [ v.constructor.name ]);
  }; 
      ...
      return function (insertable) {
          return function (text) {
              return function (items) {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 312, column 47 - line 315, column 65: " + [ insertable.constructor.name ]);
              };
          };
      };
  };
  var applyFilter = function (filterType) {
      return function (text) {
          return function (items) {
              ...
              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 304, column 37 - line 307, column 69: " + [ filterType.constructor.name ]);
          };
      };
  };
          ...
          return function (dictShow) {
              ...
              var $$eval = function (v) {
                  ...
                  if (v instanceof HandleSelect) {
                      ...
                      if (v.value0 instanceof Select.Selected) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              var selections = (function () {
                                  ...
                                  throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 201, column 28 - line 204, column 92: " + [ v1.value1.selections.constructor.name ]);
                              })();
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  var $75 = {};
                                  for (var $76 in v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 219, column 11 - line 225, column 57: " + [ v1.value1.config.syncMethod.constructor.name ]);
                                  })())(function () {
                      ...
                      throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 195, column 33 - line 232, column 17: " + [ v.value0.constructor.name ]);
                  };
                  if (v instanceof Remove) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          var selections = (function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 238, column 26 - line 241, column 60: " + [ v1.value1.selections.constructor.name ]);
                          })();
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              var $109 = {};
                              for (var $110 in v2) {
                  ...
                  if (v instanceof Synchronize) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 261, column 14 - line 271, column 50: " + [ v2.constructor.name ]);
                          })())(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
                      });
                  ...
                  if (v instanceof Reset) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          var selections = (function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 286, column 26 - line 289, column 32: " + [ v1.value1.selections.constructor.name ]);
                          })();
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              var $144 = {};
                              for (var $145 in v2) {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 191, column 12 - line 295, column 15: " + [ v.constructor.name ]);
              };
...
(function(exports) {
  ...
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.ExpansionCards line 89, column 5 - line 91, column 65: " + [ v.constructor.name ]);
      };
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleFormHeaderClick) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("submit form")))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          throw new Error("Failed pattern match at UIGuide.Components.FormControl line 42, column 12 - line 53, column 15: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
...
(function(exports) {
  ...
  var component = function (dictMonadAff) {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.Typeaheads line 71, column 5 - line 73, column 65: " + [ v.constructor.name ]);
      };
      return Halogen_Component.lifecycleParentComponent(Data_Either.ordEither(Data_Ord.ordInt)(Data_Either.ordEither(Data_Ord.ordInt)(Data_Ord.ordVoid)))({
          initialState: Data_Function["const"](Data_Unit.unit),
          render: render,
                  ...
                  return function (dictSequenceRecord) {
                      return new SequenceRecord(function (v) {
                          return function (r) {
                              ...
                              return Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Record.insert(dictIsSymbol)(dictLacks)(dictCons)(Data_Symbol.SProxy.value))(Record.get(dictIsSymbol)(dictCons1)(Data_Symbol.SProxy.value)(r)))(tail$prime);
                          };
                      });
                  };
              };
                          ...
                          return function (dictDefaultFormInputs) {
                              return new DefaultFormInputs(function (v) {
                                  return function (r) {
                                      ...
                                      return Record.insert(dictIsSymbol)(dictLacks)(dictCons)(Data_Symbol.SProxy.value)({
                                          input: Ocelot_Data_Default.def(dictDefault),
                                          validate: false,
                                          result: Data_Maybe.Nothing.value,
                                          setInput: Data_Variant.inj(dictCons1)(dictIsSymbol)(Data_Symbol.SProxy.value),
                                          setValidate: Data_Variant.inj(dictCons2)(dictIsSymbol)(Data_Symbol.SProxy.value)
                                      })(tail$prime);
                                  };
                              });
                          };
          ...
          return function (dictCons1) {
              return function (dictBuildValidateSetters) {
                  return new BuildValidateSetters(function (v) {
                      return function (v1) {
                          return function ($71) {
                              return Data_Variant.on(dictCons1)(dictIsSymbol)(Data_Symbol.SProxy.value)(function (a) {
                                  return Data_Lens_Setter.set(function ($72) {
                                      return Data_Lens_Record.prop(dictIsSymbol)(dictCons)(dictCons)(Data_Symbol.SProxy.value)(Data_Profunctor_Strong.strongFn)(Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
                                          return "validate";
              ...
              return function (name) {
                  return function (validation) {
                      return Polyform_Validation.Validation(function (inputForm) {
                          var v = Record.get(dictIsSymbol)(dictCons)(name)(inputForm);
                          var set$prime = Data_Lens_Setter.set(function ($38) {
                              return Data_Lens_Record.prop(dictIsSymbol)(dictCons)(dictCons)(name)(Data_Profunctor_Strong.strongFn)(Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
                                  return "result";
...
(function(exports) {
  ...
  var nullChar = Text_Parsing_StringParser_String["char"](unsafeFromCharCode(0));
                          ...
                          return function (sym) {
                              ...
                              var setErrors = function (rec) {
                                  return Data_Lens_Setter.set(function ($46) {
                                      return Data_Lens_Record.prop(dictIsSymbol)(dictCons)(dictCons)(sym)(Data_Profunctor_Strong.strongFn)(Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
                                          return "result";
                                      }))()()(Data_Symbol.SProxy.value)(Data_Profunctor_Strong.strongFn)($46));
                                  })((function () {
                                      var v = Data_Lens_Getter.view(function ($47) {
                                          return Data_Lens_Record.prop(dictIsSymbol)(dictCons)(dictCons1)(sym)(Data_Lens_Internal_Forget.strongForget)(Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
                                              return "result";
...
(function(exports) {
  ...
  var signupInitialForm = Ocelot_Data_Record.makeDefaultFormInputs(Ocelot_Data_Record.consDefaultFormInputs(new Data_Symbol.IsSymbol(function () {
      return "email";
  }))(Ocelot_Data_Default.defaultString)()()()()(Ocelot_Data_Record.consDefaultFormInputs(new Data_Symbol.IsSymbol(function () {
      return "p1";
  }))(Ocelot_Data_Default.defaultString)()()()()(Ocelot_Data_Record.consDefaultFormInputs(new Data_Symbol.IsSymbol(function () {
      return "p2";
  }))(Ocelot_Data_Default.defaultString)()()()()(Ocelot_Data_Record.nilDefaultFormInputs))))()(Type_Row.RProxy.value);
  ...
  var signupForm = (function () {
      var passwordForm = Control_Semigroupoid.composeFlipped(Polyform_Validation.semigroupoidValidation(Effect_Aff.monadAff)(Ocelot_Form.semigroupEndo))(Control_Apply.apply(Polyform_Validation.applyValidation(Ocelot_Form.semigroupEndo)(Effect_Aff.monadAff))(Data_Functor.map(Polyform_Validation.functorValidation(Effect_Aff.functorAff))(function (v) {
          return function (v1) {
              return {
                  p1: v,
                  p2: v1
          ...
          return "p1";
      }))(Effect_Aff.monadAff)()(_p1)(Polyform_Validation.hoistFnV(Effect_Aff.monadAff)(Data_Monoid.monoidArray)(UIGuide_Utilities_Validation.validateNonEmptyStr))))(Ocelot_Form.formFromField(new Data_Symbol.IsSymbol(function () {
          return "p2";
      }))(Effect_Aff.monadAff)()(_p2)(Polyform_Validation.hoistFnV(Effect_Aff.monadAff)(Data_Monoid.monoidArray)(UIGuide_Utilities_Validation.validateNonEmptyStr))))(Polyform_Validation.hoistFnV(Effect_Aff.monadAff)(Ocelot_Form.monoidEndo)(function (v) {
      ...
      var emailForm = Ocelot_Form.formFromField(new Data_Symbol.IsSymbol(function () {
          return "email";
      }))(Effect_Aff.monadAff)()(_email)(Control_Semigroupoid.composeFlipped(Polyform_Validation.semigroupoidValidation(Effect_Aff.monadAff)(Data_Semigroup.semigroupArray))(Polyform_Validation.hoistFnV(Effect_Aff.monadAff)(Data_Monoid.monoidArray)(UIGuide_Utilities_Validation.validateNonEmptyStr))(Polyform_Validation.hoistFnV(Effect_Aff.monadAff)(Data_Monoid.monoidArray)(UIGuide_Utilities_Validation.validateStrIsEmail("Not a valid email address."))));
      return Control_Apply.apply(Polyform_Validation.applyValidation(Ocelot_Form.semigroupEndo)(Effect_Aff.monadAff))(Data_Functor.map(Polyform_Validation.functorValidation(Effect_Aff.functorAff))(function (v) {
          return function (v1) {
              return {
                  email: v,
                  password: v1
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          if (v instanceof UpdateContents) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateValue(v.value0)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof ValidateOne) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateValidate(v.value0)))(function () {
                  return $$eval(new ValidateAll(v.value1));
              });
          };
          if (v instanceof ValidateAll) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Control_Bind.bind(Effect_Aff.bindAff)(Ocelot_Form.runForm(Effect_Aff.monadAff)()(Ocelot_Data_Record.consSequenceRecord(new Data_Symbol.IsSymbol(function () {
                      return "email";
                  }))()()()(Ocelot_Data_Record.consSequenceRecord(new Data_Symbol.IsSymbol(function () {
                      return "password";
                  }))()()()(Ocelot_Data_Record.nilSequenceRecord)))(signupForm)(v1.form))(function (v2) {
                      if (v2 instanceof Polyform_Validation.Valid) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Tuple.Tuple(v2.value0, v2.value1));
                      };
                      if (v2 instanceof Polyform_Validation.Invalid) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Tuple.Tuple(v2.value0, Data_Maybe.Nothing.value));
                      };
                      throw new Error("Failed pattern match at UIGuide.Components.Validation line 134, column 10 - line 138, column 39: " + [ v2.constructor.name ]);
                  })))(function (v2) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.Validation line 121, column 10 - line 140, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var routes = Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("expandables", {
      ...
      component: Halogen_Storybook_Proxy.proxy(UIGuide_Components_ExpansionCards.component(Effect_Aff_Class.monadAffAff)),
      ...
      anchor: "Typeaheads",
      component: Halogen_Storybook_Proxy.proxy(UIGuide_Components_Typeaheads.component(Effect_Aff_Class.monadAffAff)),
      group: UIGuide_App.Components.value
      ...
      anchor: "Modals",
      component: Halogen_Storybook_Proxy.proxy(UIGuide_Components_Modals.component(Effect_Aff_Class.monadAffAff)),
      group: UIGuide_App.Components.value
