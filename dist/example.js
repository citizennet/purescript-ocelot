  ...
  var component = (function () {
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ UIGuide_Block_Documentation.documentation({
              ...
              valid: Data_Maybe.Nothing.value,
              inputId: "range"
          })(CN_UI_Block_Range.range("range")(0.0)(100.0)("A lot")("All of Them")([  ])) ]) ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.FormControl line 44, column 12 - line 50, column 15: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
          initialState: Data_Function["const"](Data_Unit.unit),
          render: render,
