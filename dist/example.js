...
(function(exports) {
  ...
  exports["showE"] = showE;
  exports["htmlE"] = htmlE;
})(PS["CN.UI.Core.Validation"] = PS["CN.UI.Core.Validation"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var CN_UI_Core_Validation = PS["CN.UI.Core.Validation"];
  var Data_Functor = PS["Data.Functor"];
  var Data_Maybe = PS["Data.Maybe"];
  var Halogen_HTML = PS["Halogen.HTML"];
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  ...
  var errorTextClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "leading-loose", "text-red", "text-sm", "font-bold" ]);
  var formControl = function (props) {
      return function (html) {
          ...
          var helpText = function (v) {
              return function (v1) {
                  if (v instanceof Data_Maybe.Just) {
                      return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes(errorTextClasses) ])(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML.fromPlainHTML)(CN_UI_Core_Validation.htmlE(v.value0)));
                  };
              ...
              return function (renderSelection) {
                  return function (st) {
                      var renderSelections = (function () {
                          ...
                          throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 216, column 7 - line 241, column 12: " + [ st.selections.constructor.name ]);
                      })();
  ...
  var boldMatches = function (key) {
      return function (v) {
          var boldMatch = function (v1) {
              ...
              throw new Error("Failed pattern match at CN.UI.Components.Typeahead line 305, column 5 - line 305, column 39: " + [ v1.constructor.name ]);
          };
...
(function(exports) {
  ...
  var loadFromSource = function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 78, column 58 - line 84, column 32: " + [ v.speed.constructor.name ]);
  };
  var load = function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.Utilities.Async line 67, column 1 - line 69, column 75: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var typeaheadBlockStrings = function (dictMonadAff) {
      ...
      var fuzzyConfig = {
          renderKey: "id",
          toStrMap: Data_StrMap.singleton("value")
      };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleTypeahead) {
              if (v.value1 instanceof CN_UI_Core_Typeahead.RequestData) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(dictMonadAff)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(UIGuide_Utilities_Async.load(v.value1.value0)))(function (v1) {
                      ...
                      throw new Error("Failed pattern match at UIGuide.Components.TextFields line 88, column 11 - line 92, column 24: " + [ v2.constructor.name ]);
                  })))(function (v1) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
                  });
              };
          ...
          if (v instanceof HandleDropdown) {
              return Control_Apply.applyFirst(Halogen_Query_HalogenM.applyHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1))((function () {
                  ...
                  throw new Error("Failed pattern match at UIGuide.Components.TextFields line 98, column 49 - line 102, column 74: " + [ v.value0.constructor.name ]);
              })());
          };
          throw new Error("Failed pattern match at UIGuide.Components.TextFields line 76, column 5 - line 76, column 91: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var validateUsername = function (uname) {
      return Data_Bifunctor.bimap(Data_Validation_Semigroup.bifunctorV)(Data_Map.singleton(FailUsername.value))(function ($136) {
          return Username(Data_String_Utils.fromCharArray($136));
      })(Control_Apply.applySecond(Data_Validation_Semigroup.applyV(Data_Semigroup.semigroupArray))(CN_UI_Core_Validation.validateNonEmptyStr(uname))(CN_UI_Core_Validation.validateMinLength(Data_Foldable.foldableArray)(8)("Username must be longer than 8 characters")(Data_String_Utils.toCharArray(uname))));
  };
  var validateUserDependence = function (users1) {
      return function (users2) {
          return CN_UI_Core_Validation.validateDependence(function (u1) {
              return function (u2) {
  ...
  var validateUsers1 = function (users1) {
      return function (users2) {
          return Data_Bifunctor.bimap(Data_Validation_Semigroup.bifunctorV)(Data_Map.singleton(FailUsers1.value))(ValidatedArray)(Control_Apply.applySecond(Data_Validation_Semigroup.applyV(Data_Semigroup.semigroupArray))(Control_Apply.applySecond(Data_Validation_Semigroup.applyV(Data_Semigroup.semigroupArray))(CN_UI_Core_Validation.validateNonEmptyArr(users1))(CN_UI_Core_Validation.validateMinLength(Data_Foldable.foldableArray)(2)("Must select more than one user")(users1)))(validateUserDependence(users2)(users2)));
      };
  };
  var validateUsers2 = function (users2) {
      return function (users1) {
          return Data_Bifunctor.bimap(Data_Validation_Semigroup.bifunctorV)(Data_Map.singleton(FailUsers2.value))(ValidatedArray)(Control_Apply.applySecond(Data_Validation_Semigroup.applyV(Data_Semigroup.semigroupArray))(CN_UI_Core_Validation.validateNonEmptyArr(users2))(validateUserDependence(users2)(users1)));
      };
  };
  ...
  var validateField = function (v) {
      ...
      throw new Error("Failed pattern match at UIGuide.Components.Validation line 305, column 1 - line 305, column 47: " + [ v.constructor.name ]);
  };
  ...
  var renderItem = CN_UI_Components_Typeahead.defaultSelectionRow(function ($137) {
      return Halogen_HTML_Core.text((function (v) {
          return v.name;
      })(Data_Newtype.unwrap(newtypeTestRecord)($137)));
  });        
  var eqTestRecord = new Data_Eq.Eq(function (v) {
      return function (v1) {
          return v.id === v1.id;
  ...
  var ordFormErrorKey = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.Validation line 285, column 8 - line 285, column 52: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  ...
  var cp2 = Halogen_Component_ChildPath.cp2;
  var cp1 = Halogen_Component_ChildPath.cp1;
  var component = function (dictMonadAff) {
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ renderForm(dictMonadAff)(st) ]);
      };
      var load = function (cp) {
          return function (m) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(UIGuide_Utilities_Async.load(m)))(function (v) {
                  var v1 = CN_UI_Core_Typeahead.maybeReplaceItems(v)(m);
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))))(cp)(Data_Unit.unit)(Halogen_Query.action(CN_UI_Core_Typeahead.FulfillRequest.create(v1.value0))))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      });
                  };
                  throw new Error("Failed pattern match at UIGuide.Components.Validation line 169, column 7 - line 173, column 21: " + [ v1.constructor.name ]);
              });
          };
      };
      var $$eval = function (v) {
          ...
          if (v instanceof HandleB) {
              if (v.value0 instanceof CN_UI_Core_Typeahead.RequestData) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(load(Halogen_Component_ChildPath.cp2)(v.value0.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
          if (v instanceof HandleC) {
              if (v.value0 instanceof CN_UI_Core_Typeahead.RequestData) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(load(Halogen_Component_ChildPath.cp3)(v.value0.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
          if (v instanceof HandleD) {
              if (v.value0 instanceof CN_UI_Core_Typeahead.RequestData) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(load(Halogen_Component_ChildPath.cp4)(v.value0.value0))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          };
          if (v instanceof UpdateTextField) {
              if (v.value0 === 1) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $102.raw = (function () {
                          var $99 = {};
                          for (var $100 in v1.raw) {
                              if ({}.hasOwnProperty.call(v1.raw, $100)) {
                                  $99[$100] = v1["raw"][$100];
                              };
                          };
                          $99.email = v.value1;
              ...
              if (v.value0 === 2) {
                  return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $108.raw = (function () {
                          var $105 = {};
                          for (var $106 in v1.raw) {
                              if ({}.hasOwnProperty.call(v1.raw, $106)) {
                                  $105[$106] = v1["raw"][$106];
                              };
                          };
                          $105.username = v.value1;
                          return $105;
                      })();
                      return $108;
                  }))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2));
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))))(Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Halogen_Query.request(CN_UI_Core_Typeahead.Selections.create)))(function (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))))(Halogen_Component_ChildPath.cp4)(Data_Unit.unit)(Halogen_Query.request(CN_UI_Core_Typeahead.Selections.create)))(function (v4) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                  var $128 = {};
                                  for (var $129 in v5) {
                                      if ({}.hasOwnProperty.call(v5, $129)) {
                                          $128[$129] = v5[$129];
                                      };
                                  };
                                  $128.raw = (function () {
                                      var $125 = {};
                                      for (var $126 in v5.raw) {
                                          if ({}.hasOwnProperty.call(v5.raw, $126)) {
                                              $125[$126] = v5["raw"][$126];
                                          };
                                      };
                                      $125.developers = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(CN_UI_Core_Typeahead.unpackSelections)(v1));
                                      $125.todos = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(CN_UI_Core_Typeahead.unpackSelections)(v2));
                                      $125.users1 = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(CN_UI_Core_Typeahead.unpackSelections)(v3));
                                      $125.users2 = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(CN_UI_Core_Typeahead.unpackSelections)(v4));
                                      return $125;
                                  })();
                                  return $128;
                              }))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v5) {
                                      var validation = runValidation(v5.raw);
