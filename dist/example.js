...
(function(exports) {
  ...
  var app = function (stories) {
      var renderSlot = function (state) {
          var v = Data_StrMap.lookup(state.route)(stories);
          if (v instanceof Data_Maybe.Just) {
              return Halogen_HTML.slot(state.route)(v.value0)(Data_Unit.unit)(Data_Void.absurd);
          };
          return Halogen_HTML_Elements.div_([  ]);
      };
      var renderNavs = function (v) {
          var linkActiveClass = "hover:underline text-grey-darkest" + " font-bold text-black";
          return Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.class_("list-reset") ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_StrMap.keys(stories))(function (name) {
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("mb-3") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName((function () {
                  var $9 = v.route === name;
                  if ($9) {
                      return linkActiveClass;
                  };
                  return "hover:underline text-grey-darkest";
              })())), Halogen_HTML_Properties.href("#" + Global["encodeURI"](name)) ])([ Halogen_HTML_Core.text(name) ]) ]);
          }));
      };
  ...
  var runStorybook = function (stories) {
      return function (body) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(app(stories))(Data_Unit.unit)(body))(function (v) {
