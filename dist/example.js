...
(function(exports) {
  ...
  var helpText = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Ocelot.Block.FormField line 163, column 1 - line 167, column 17: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var errorText = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Ocelot.Block.FormField line 146, column 1 - line 150, column 17: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var unpackSelections = function (v) {
      ...
      throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 359, column 1 - line 359, column 61: " + [ v.constructor.name ]);
  }; 
      ...
      return function (insertable) {
          return function (text) {
              return function (items) {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 324, column 47 - line 327, column 65: " + [ insertable.constructor.name ]);
              };
          };
      };
  };
  var applyFilter = function (filterType) {
      return function (text) {
          return function (items) {
              ...
              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 316, column 37 - line 319, column 69: " + [ filterType.constructor.name ]);
          };
      };
  };
      ...
      return function (dictEq) {
          return function (dictShow) {
              ...
              var $$eval = function (v) {
                  ...
                  if (v instanceof Synchronize) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 272, column 14 - line 283, column 50: " + [ v2.constructor.name ]);
                          })())(function (v2) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
                      });
                  ...
                  if (v instanceof Reset) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Select_Internal_State.getState(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                          var selections = (function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 298, column 26 - line 301, column 32: " + [ v1.value1.selections.constructor.name ]);
                          })();
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(Control_Comonad_Store_Class.seeks(Control_Comonad_Store_Class.comonadStoreStoreT(Data_Identity.comonadIdentity))(function (v2) {
                              var $144 = {};
                              for (var $145 in v2) {
                  ...
                  throw new Error("Failed pattern match at Ocelot.Components.Typeahead line 202, column 12 - line 307, column 15: " + [ v.constructor.name ]);
              };
                      ...
                      return function (st) {
                          var renderError = (function () {
                              if (Network_RemoteData.isFailure(st.items)) {
                                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("flex items-center mt-1") ])([ Ocelot_Block_Icon.error([ Halogen_HTML_Properties.class_("text-2xl text-yellow") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("ml-3 text-grey-70") ])([ Halogen_HTML_Core.text("Some data could not be retrieved here.") ]) ]);
                              };
                              if (Data_Boolean.otherwise) {
                                  return Halogen_HTML_Elements.div_([  ]);
                              };
                              throw new Error("Failed pattern match at Ocelot.Components.Typeahead.Input line 372, column 5 - line 382, column 30: " + [  ]);
                          })();
                          ...
                          var linkClasses = (function () {
                              if (isDisabled === true) {
                                  return [ "text-grey-dark no-underline font-medium" ];
                              };
                              if (Data_Boolean.otherwise) {
                          ...
                          var disabledClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "bg-grey-95", "text-grey-dark", "sibling:bg-grey-95", "sibling:text-grey-dark", "border-t-2", "border-b-2", "font-light", "cc-blue-88", "focus:no-outline", "py-2", "border-l-2", "w-full", "px-3" ]);
                      ...
                      return function (v1) {
                          return function ($42) {
                              return Data_Variant.on(dictRowCons1)(dictIsSymbol)(Data_Symbol.SProxy.value)(function (a) {
                                  return Data_Lens_Setter.set(function ($43) {
                                      return Data_Lens_Record.prop(dictIsSymbol)(dictRowCons)(dictRowCons)(Data_Symbol.SProxy.value)(Data_Profunctor_Strong.strongFn)(Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
                                          return "validate";
                                      }))()()(Data_Symbol.SProxy.value)(Data_Profunctor_Strong.strongFn)($43));
                                  })(a);
                              })(buildValidateSetters(dictBuildValidateSetters)(Type_Row.RLProxy.value)(Type_Row.RProxy.value)($42));
                          };
                      };
                  });
              };
              ...
              return function (dictBuildInputSetters) {
                  return new BuildInputSetters(function (v) {
                      return function (v1) {
                          return function ($44) {
                              return Data_Variant.on(dictRowCons1)(dictIsSymbol)(Data_Symbol.SProxy.value)(function (a) {
                                  return Data_Lens_Setter.set(function ($45) {
                                      return Data_Lens_Record.prop(dictIsSymbol)(dictRowCons)(dictRowCons)(Data_Symbol.SProxy.value)(Data_Profunctor_Strong.strongFn)(Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
                                          return "input";
                                      }))()()(Data_Symbol.SProxy.value)(Data_Profunctor_Strong.strongFn)($45));
                                  })(a);
                              })(buildInputSetters(dictBuildInputSetters)(Type_Row.RLProxy.value)(Type_Row.RProxy.value)($44));
                          };
                      };
                  });
              };
...
(function(exports) {
                  ...
                  return function (initial) {
                      return Control_Bind.bind(dictMonad.Bind1())(Data_Newtype.unwrap(Polyform_Validation.newtypeVaildation)(formValidation)(initial))(function (v) {
                          return Control_Applicative.pure(dictMonad.Applicative0())((function () {
                              ...
                              throw new Error("Failed pattern match at Ocelot.Form line 149, column 10 - line 151, column 53: " + [ v.constructor.name ]);
                          })());
                      });
                  };
              };
              ...
              return function (name) {
                  return function (validation) {
                      return Polyform_Validation.Validation(function (inputForm) {
                          ...
                          var set$prime = Data_Lens_Setter.set(function ($36) {
                              return Data_Lens_Record.prop(dictIsSymbol)(dictRowCons)(dictRowCons)(name)(Data_Profunctor_Strong.strongFn)(Data_Lens_Record.prop(new Data_Symbol.IsSymbol(function () {
                                  return "result";
                              }))()()(Data_Symbol.SProxy.value)(Data_Profunctor_Strong.strongFn)($36));
                          });
                          if (v.validate) {
                              return Control_Bind.bind(dictMonad.Bind1())(Data_Newtype.unwrap(Polyform_Validation.newtypeVaildation)(validation)(v.input))(function (v1) {
                                  return Control_Applicative.pure(dictMonad.Applicative0())((function () {
                                      ...
                                      throw new Error("Failed pattern match at Ocelot.Form line 128, column 14 - line 132, column 48: " + [ v1.constructor.name ]);
                                  })());
                              });
                          };
  ...
  var check = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Ocelot.Form line 61, column 1 - line 61, column 82: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  exports["Endo"] = Endo;
  exports["check"] = check;
