...
})(PS["CN.UI.Block.FormPanel"] = PS["CN.UI.Block.FormPanel"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var DOM_HTML_Indexed = PS["DOM.HTML.Indexed"];
...
(function(exports) {
  ...
  var liClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "px-3", "py-1" ]);
  var groupClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "group", "leading-normal", "hover:bg-grey-lightest" ]);
  var buttonClasses = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "text-grey-light", "float-right", "leading-normal", "invisible", "group-hover:visible" ]);
  var selectionGroup = function (f) {
      return function (props) {
          return function (item) {
              return Halogen_HTML_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(props)([ Halogen_HTML_Properties.classes(groupClasses) ]))([ Halogen_HTML.fromPlainHTML(f(item)), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(buttonClasses) ])([ Halogen_HTML_Core.text("\xd7") ]) ]);
          };
      };
  };
  var boldMatches = function (key) {
      return function (v) {
          var boldMatch = function (v1) {
              ...
              throw new Error("Failed pattern match at CN.UI.Block.ItemContainer line 120, column 5 - line 120, column 39: " + [ v1.constructor.name ]);
          };
  ...
  var selectionContainerClasses = (function () {
      var names = Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "border-b", "border-grey-lighter" ]);
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(baseClasses)(names);
  })();
...
})(PS["CN.UI.Block.ItemContainer"] = PS["CN.UI.Block.ItemContainer"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Data_Eq = PS["Data.Eq"];
...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var range = function (inputId) {
      return function (min) {
          return function (max) {
              return function (minLabel) {
                  return function (maxLabel) {
                      return function (iprops) {
                          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("flex items-center w-full") ])([ Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("flex-no-grow text-sm mr-4") ])([ Halogen_HTML_Core.text(minLabel) ]), Halogen_HTML_Elements.input(Data_Semigroup.append(Data_Semigroup.semigroupArray)(iprops)([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.min(min), Halogen_HTML_Properties.max(max), Halogen_HTML_Properties.id_(inputId), Halogen_HTML_Properties.class_("bg-transparent flex-1") ])), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("flex-no-grow text-sm ml-4") ])([ Halogen_HTML_Core.text(maxLabel) ]) ]);
                      };
                  };
              };
          };
  ...
  exports["range"] = range;
})(PS["CN.UI.Block.Range"] = PS["CN.UI.Block.Range"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var DOM_HTML_Indexed = PS["DOM.HTML.Indexed"];
...
(function(exports) {
  ...
  var CN_UI_Block_ItemContainer = PS["CN.UI.Block.ItemContainer"];
...
(function(exports) {
  ...
  var CN_UI_Block_FormPanel = PS["CN.UI.Block.FormPanel"];
  var CN_UI_Block_Input = PS["CN.UI.Block.Input"];
  var CN_UI_Block_Radio = PS["CN.UI.Block.Radio"];
  var CN_UI_Block_Range = PS["CN.UI.Block.Range"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ UIGuide_Block_Documentation.documentation({
              ...
              title: "Range"
          })([ CN_UI_Block_Range.range("range_")(0.0)(100.0)("Min Label")("Max Label")([  ]) ]), UIGuide_Block_Component.component({
              ...
              valid: Data_Maybe.Nothing.value,
              inputId: "range"
          })(CN_UI_Block_Range.range("range")(0.0)(100.0)("A lot")("All of Them")([  ])) ]) ]), UIGuide_Block_Documentation.documentation({
              header: "Form Panel",
              subheader: "Collapse + Expand Form Controls"
          })([ UIGuide_Block_Component.component({
              title: "Form Panel"
          })([ CN_UI_Block_FormPanel.formPanel({
          ...
          })([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input(ToggleFormPanel.create)) ])([ CN_UI_Block_FormControl.formControl({
              label: "Email",
              helpText: new Data_Maybe.Just("Dave will spam your email with gang of four patterns"),
              valid: Data_Maybe.Nothing.value,
              inputId: "email'"
          })(CN_UI_Block_Input.input([ Halogen_HTML_Properties.placeholder("davelovesdesignpatterns@gmail.com"), Halogen_HTML_Properties.id_("email'") ])) ]) ]) ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at UIGuide.Components.FormControl line 49, column 12 - line 60, column 15: " + [ v.constructor.name ]);
      };
      return Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
...
(function(exports) {
  ...
  var renderItemUser = {
      ...
      renderItem: function ($72) {
          return CN_UI_Components_Typeahead.defRenderItem(Data_Newtype.unwrap(newtypeUser)($72));
      },
      renderFuzzy: CN_UI_Components_Typeahead.defRenderFuzzy
  };
  ...
  var renderItemTodo = {
      ...
      renderFuzzy: function ($74) {
          return Halogen_HTML_Elements.span_(CN_UI_Block_ItemContainer.boldMatches("title")($74));
      }
  };
...
(function(exports) {
  ...
  var dropdownMultiSlot = function (dictMonadAff) {
      return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Data_Unit.unit)(CN_UI_Components_Dropdown.component(dictMonadAff)(eqTestRecord))({
          items: dropdownData,
          itemHTML: function (i) {
              return [ Halogen_HTML_Core.text((function (v) {
                  return v.name;
...
(function(exports) {
  ...
  var renderItemTestRecord = {
      ...
      renderFuzzy: CN_UI_Components_Typeahead.defRenderFuzzy,
      renderItem: function ($136) {
          return CN_UI_Components_Typeahead.defRenderItem(Data_Newtype.unwrap(newtypeTestRecord)($136));
      }
  };         
  var eqTestRecord = new Data_Eq.Eq(function (v) {
      return function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query["query'"](Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Either.eqEither(Data_Eq.eqUnit)(Data_Eq.eqVoid)))))(Halogen_Component_ChildPath.cp4)(Data_Unit.unit)(Halogen_Query.request(CN_UI_Core_Typeahead.Selections.create)))(function (v4) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                  ...
                                  $127.raw = (function () {
                                      ...
                                      $124.developers = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(CN_UI_Core_Typeahead.unpackSelections)(v1));
                                      $124.todos = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(CN_UI_Core_Typeahead.unpackSelections)(v2));
                                      $124.users1 = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(CN_UI_Core_Typeahead.unpackSelections)(v3));
                                      $124.users2 = Data_Maybe.fromMaybe([  ])(Data_Functor.map(Data_Maybe.functorMaybe)(CN_UI_Core_Typeahead.unpackSelections)(v4));
                                      return $124;
                                  })();
                                  return $127;
                              }))(function () {
