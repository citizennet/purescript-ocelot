...
import Data.Either.Nested (Either2, Either4, Either8)
import Data.Functor.Coproduct.Nested (Coproduct2, Coproduct4, Coproduct8)
...
data Query a
  = NoOp a
  | HandleTypeaheadUser Unit (TACore.Message Query Async.User) a
  | HandleTypeaheadLocation Unit (TACore.Message Query Async.Location) a
  | Initialize a
...
component =
  ...
  where
    ...
    eval (Initialize next) = do
      _ <- H.query' CP.cp1 unit $ H.action $ TACore.ReplaceItems Loading
      _ <- H.query' CP.cp2 unit $ H.action $ TACore.ReplaceItems Loading
      _ <- H.query' CP.cp3 unit $ H.action $ TACore.ReplaceItems Loading
      _ <- H.query' CP.cp4 unit $ H.action $ TACore.ReplaceItems Loading
      _ <- H.query' CP.cp5 unit $ H.action $ TACore.ReplaceItems Loading
      _ <- H.query' CP.cp6 unit $ H.action $ TACore.ReplaceItems Loading
      _ <- H.query' CP.cp7 unit $ H.action $ TACore.ReplaceItems Loading
      _ <- H.query' CP.cp8 unit $ H.action $ TACore.ReplaceItems Loading
      remoteLocations <- H.liftAff $ Async.loadFromSource Async.locations ""
      _ <- case remoteLocations of
        items@(Success _) -> do
          _ <- H.query' CP.cp1 unit $ H.action $ TACore.ReplaceItems items
          _ <- H.query' CP.cp2 unit $ H.action $ TACore.ReplaceItems items
          _ <- H.query' CP.cp5 unit $ H.action $ TACore.ReplaceItems items
          _ <- H.query' CP.cp6 unit $ H.action $ TACore.ReplaceItems items
          pure unit
        otherwise -> pure unit
      remoteUsers <- H.liftAff $ Async.loadFromSource Async.users ""
      _ <- case remoteUsers of
        items@(Success _) -> do
          _ <- H.query' CP.cp3 unit $ H.action $ TACore.ReplaceItems items
          _ <- H.query' CP.cp4 unit $ H.action $ TACore.ReplaceItems items
          _ <- H.query' CP.cp7 unit $ H.action $ TACore.ReplaceItems items
          _ <- H.query' CP.cp8 unit $ H.action $ TACore.ReplaceItems items
          pure unit
        otherwise -> pure unit
      ...
      case selectedUsers of
        Success xs -> do
          _ <- H.query' CP.cp4 unit
            $ H.action
            $ TACore.ReplaceSelections
            $ TACore.One
            $ head xs
          _ <- H.query' CP.cp8 unit
            $ H.action
            $ TACore.ReplaceSelections
            $ TACore.Many
            $ take 4 xs
          ...
          [ Card.card
            ...
            , FormControl.formControl
              ...
              ( HH.slot' CP.cp1 unit TACore.component
                ...
                ( HE.input $ HandleTypeaheadLocation unit )
              )
            , HH.h3
              [ HP.classes Type.captionClasses ]
          ...
          [ Card.card
            ...
            , FormControl.formControl
              ...
              ( HH.slot' CP.cp3 unit TACore.component
                ...
                ( HE.input $ HandleTypeaheadUser unit )
              )
            , HH.h3
              [ HP.classes Type.captionClasses ]
        ...
        [ content
          [ Card.card
            ...
            , FormControl.formControl
              ...
              ( HH.slot' CP.cp5 unit TACore.component
                (TA.defAsyncMulti
                  [ HP.placeholder "Search locations..."
                  , HP.id_ "locations"
                  ]
            ...
            , FormControl.formControl
              ...
              ( HH.slot' CP.cp6 unit TACore.component
                (TA.defAsyncMulti
                  [ HP.placeholder "Search locations..."
                  , HP.id_ "locations"
                  ]
        ...
        , content
          [ Card.card
            ...
            , FormControl.formControl
              ...
              ( HH.slot' CP.cp7 unit TACore.component
                (TA.defAsyncMulti
                  [ HP.placeholder "Search users..."
                  , HP.id_ "users"
                  ]
            ...
            , FormControl.formControl
              ...
              ( HH.slot' CP.cp8 unit TACore.component
                (TA.defAsyncMulti
                  [ HP.placeholder "Search users..."
